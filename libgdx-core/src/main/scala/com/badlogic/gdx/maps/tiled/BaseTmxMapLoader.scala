...
abstract class BaseTmxMapLoader[P <: com.badlogic.gdx.maps.tiled.BaseTiledMapLoader#Parameters] extends com.badlogic.gdx.maps.tiled.BaseTiledMapLoader[P] {
  protected var xml: com.badlogic.gdx.utils.XmlReader = new com.badlogic.gdx.utils.XmlReader()
  protected var root: com.badlogic.gdx.utils.XmlReader#Element = null.asInstanceOf[com.badlogic.gdx.utils.XmlReader#Element]
  protected var templateCache: com.badlogic.gdx.utils.ObjectMap[java.lang.String, com.badlogic.gdx.utils.XmlReader#Element] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectMap[java.lang.String, com.badlogic.gdx.utils.XmlReader#Element]]
  ...
  protected def loadTiledMap(tmxFile: com.badlogic.gdx.files.FileHandle, parameter: P, imageResolver: com.badlogic.gdx.maps.ImageResolver): com.badlogic.gdx.maps.tiled.TiledMap = {
  ...
  protected def loadLayer(map: com.badlogic.gdx.maps.tiled.TiledMap, parentLayers: com.badlogic.gdx.maps.MapLayers, element: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle, imageResolver: com.badlogic.gdx.maps.ImageResolver): scala.Unit = {
  ...
  protected def loadLayerGroup(map: com.badlogic.gdx.maps.tiled.TiledMap, parentLayers: com.badlogic.gdx.maps.MapLayers, element: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle, imageResolver: com.badlogic.gdx.maps.ImageResolver): scala.Unit = {
  ...
  protected def loadTileLayer(map: com.badlogic.gdx.maps.tiled.TiledMap, parentLayers: com.badlogic.gdx.maps.MapLayers, element: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
  ...
  protected def loadObjectGroup(map: com.badlogic.gdx.maps.tiled.TiledMap, parentLayers: com.badlogic.gdx.maps.MapLayers, element: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle): scala.Unit = {
  ...
  protected def loadImageLayer(map: com.badlogic.gdx.maps.tiled.TiledMap, parentLayers: com.badlogic.gdx.maps.MapLayers, element: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle, imageResolver: com.badlogic.gdx.maps.ImageResolver): scala.Unit = {
  ...
  protected def loadBasicLayerInfo(layer: com.badlogic.gdx.maps.MapLayer, element: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
  ...
  protected def loadObject(map: com.badlogic.gdx.maps.tiled.TiledMap, layer: com.badlogic.gdx.maps.MapLayer, element: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
    this.loadObject(map, layer.getObjects(), element, mapHeightInPixels)
  }
  protected def loadObject(map: com.badlogic.gdx.maps.tiled.TiledMap, tile: com.badlogic.gdx.maps.tiled.TiledMapTile, element: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
    this.loadObject(map, tile.getObjects(), element, tile.getTextureRegion().getRegionHeight())
  }
  protected def loadObject(map: com.badlogic.gdx.maps.tiled.TiledMap, objects: com.badlogic.gdx.maps.MapObjects, element: com.badlogic.gdx.utils.XmlReader#Element, heightInPixels: scala.Float): scala.Unit = {
  ...
  protected def resolveTemplateObject(map: com.badlogic.gdx.maps.tiled.TiledMap, layer: com.badlogic.gdx.maps.MapLayer, mapElement: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle): com.badlogic.gdx.utils.XmlReader#Element = {
  ...
  protected def cloneElementShallow(sourceElement: com.badlogic.gdx.utils.XmlReader#Element): com.badlogic.gdx.utils.XmlReader#Element = {
  ...
  protected def mergeProperties(parentProps: com.badlogic.gdx.utils.XmlReader#Element, templateProps: com.badlogic.gdx.utils.XmlReader#Element): com.badlogic.gdx.utils.XmlReader#Element = {
  ...
  protected def mergeParentElementWithTemplate(parent: com.badlogic.gdx.utils.XmlReader#Element, template: com.badlogic.gdx.utils.XmlReader#Element): com.badlogic.gdx.utils.XmlReader#Element = {
    if (template == null) {
      return parent
    } else ()
    if (parent == null) {
  ...
  protected def loadProperties(properties: com.badlogic.gdx.maps.MapProperties, element: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
    if (element == null) {
      return
    } else ()
  ...
  protected def loadClassProperties(className: java.lang.String, classProperties: com.badlogic.gdx.maps.MapProperties, classElement: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
  ...
  protected def getPropertyByName(classElement: com.badlogic.gdx.utils.XmlReader#Element, propName: java.lang.String): com.badlogic.gdx.utils.XmlReader#Element = {
  ...
  protected def loadTileSet(element$arg: com.badlogic.gdx.utils.XmlReader#Element, tmxFile: com.badlogic.gdx.files.FileHandle, imageResolver: com.badlogic.gdx.maps.ImageResolver): scala.Unit = {
  ...
  protected def addTileProperties(tile: com.badlogic.gdx.maps.tiled.TiledMapTile, tileElement: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
  ...
  protected def addTileObjectGroup(tile: com.badlogic.gdx.maps.tiled.TiledMapTile, tileElement: com.badlogic.gdx.utils.XmlReader#Element): scala.Unit = {
  ...
  protected def createAnimatedTile(tileSet: com.badlogic.gdx.maps.tiled.TiledMapTileSet, tile: com.badlogic.gdx.maps.tiled.TiledMapTile, tileElement: com.badlogic.gdx.utils.XmlReader#Element, firstgid: scala.Int): com.badlogic.gdx.maps.tiled.tiles.AnimatedTiledMapTile = {
  ...
  def getTileIds(element: com.badlogic.gdx.utils.XmlReader#Element, width: scala.Int, height: scala.Int): scala.Array[scala.Int] = {
    ...
    if (encoding.equals("csv")) {
      ...
      { var i: scala.Int = 0; while (i < array.length) { {
        ids(i) = java.lang.Long.parseLong(array(i).trim()).asInstanceOf[scala.Int]
      }; i = i + 1 } }
    } else {
      if (true) {
