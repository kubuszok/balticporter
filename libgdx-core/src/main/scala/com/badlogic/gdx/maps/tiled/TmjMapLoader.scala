...
class TmjMapLoader extends com.badlogic.gdx.maps.tiled.BaseTmjMapLoader[com.badlogic.gdx.maps.tiled.BaseTiledMapLoader#Parameters] {
  ...
  protected def getDependencyAssetDescriptors(tmjFile: com.badlogic.gdx.files.FileHandle, textureParameter: com.badlogic.gdx.assets.loaders.TextureLoader#TextureParameter): com.badlogic.gdx.utils.Array[com.badlogic.gdx.assets.AssetDescriptor] = {
  ...
  protected def getDependencyFileHandles(tmjFile: com.badlogic.gdx.files.FileHandle): com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle] = {
  ...
  protected def getTileSetDependencyFileHandle(tmjFile: com.badlogic.gdx.files.FileHandle, tileSet: com.badlogic.gdx.utils.JsonValue): com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle] = {
    val fileHandles: com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle] = new com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle]()
    return this.getTileSetDependencyFileHandle(fileHandles, tmjFile, tileSet)
  }
  protected def getTileSetDependencyFileHandle(fileHandles: com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle], tmjFile: com.badlogic.gdx.files.FileHandle, tileSet$arg: com.badlogic.gdx.utils.JsonValue): com.badlogic.gdx.utils.Array[com.badlogic.gdx.files.FileHandle] = {
