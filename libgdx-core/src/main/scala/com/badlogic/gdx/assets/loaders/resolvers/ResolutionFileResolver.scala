...
class ResolutionFileResolver extends com.badlogic.gdx.assets.loaders.FileHandleResolver {
  protected var baseResolver: com.badlogic.gdx.assets.loaders.FileHandleResolver = null.asInstanceOf[com.badlogic.gdx.assets.loaders.FileHandleResolver]
  protected var descriptors: scala.Array[Resolution] = null.asInstanceOf[scala.Array[Resolution]]
  def this(baseResolver: com.badlogic.gdx.assets.loaders.FileHandleResolver, descriptors: scala.Array[Resolution]) = {
    this()
  ...
  def resolve(fileName: java.lang.String): com.badlogic.gdx.files.FileHandle = {
    val bestResolution: Resolution = ResolutionFileResolver.choose(this.descriptors)
  ...
  protected def resolve(originalHandle: com.badlogic.gdx.files.FileHandle, suffix: java.lang.String): java.lang.String = {
...
object ResolutionFileResolver {
  def choose(descriptors: scala.Array[Resolution]): Resolution = {
    ...
    var best: Resolution = descriptors(0)
    if (w < h) {
      { var i: scala.Int = 0; val n: scala.Int = descriptors.length; while (i < n) { {
        val other: Resolution = descriptors(i)
