...
class BitmapFontLoader extends com.badlogic.gdx.assets.loaders.AsynchronousAssetLoader[com.badlogic.gdx.graphics.g2d.BitmapFont, BitmapFontParameter] {
  ...
  def getDependencies(fileName: java.lang.String, file: com.badlogic.gdx.files.FileHandle, parameter: BitmapFontParameter): com.badlogic.gdx.utils.Array[com.badlogic.gdx.assets.AssetDescriptor] = {
    ...
    if ((parameter != null) && (parameter.atlasName != null)) {
      deps.add(new com.badlogic.gdx.assets.AssetDescriptor(parameter.atlasName, classOf[java.lang.Class]))
    } else {
      { var i: scala.Int = 0; while (i < this.data.getImagePaths().length) { {
        ...
        val descriptor: com.badlogic.gdx.assets.AssetDescriptor = new com.badlogic.gdx.assets.AssetDescriptor(resolved, classOf[java.lang.Class], textureParams)
        deps.add(descriptor)
      }; i = i + 1 } }
    }
    return deps
  }
  def loadAsync(manager: com.badlogic.gdx.assets.AssetManager, fileName: java.lang.String, file: com.badlogic.gdx.files.FileHandle, parameter: BitmapFontParameter): scala.Unit = {
    ()
  }
  def loadSync(manager: com.badlogic.gdx.assets.AssetManager, fileName: java.lang.String, file: com.badlogic.gdx.files.FileHandle, parameter: BitmapFontParameter): com.badlogic.gdx.graphics.g2d.BitmapFont = {
    if ((parameter != null) && (parameter.atlasName != null)) {
      val atlas: com.badlogic.gdx.graphics.g2d.TextureAtlas = manager.get(parameter.atlasName, classOf[java.lang.Class])
      ...
      val regs: com.badlogic.gdx.utils.Array[com.badlogic.gdx.graphics.g2d.TextureRegion] = new com.badlogic.gdx.utils.Array(n)
      { var i: scala.Int = 0; while (i < n) { {
        regs.add(new com.badlogic.gdx.graphics.g2d.TextureRegion(manager.get(this.data.getImagePath(i), classOf[java.lang.Class])))
      }; i = i + 1 } }
