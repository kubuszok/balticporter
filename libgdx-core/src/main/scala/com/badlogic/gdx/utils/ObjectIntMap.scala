...
class ObjectIntMap[K](initialCapacity: scala.Int, loadFactor$p: scala.Float) extends balticporter.runtime.JavaIterable[com.badlogic.gdx.utils.ObjectIntMap.Entry[K]] {
  ...
  var entries1: com.badlogic.gdx.utils.ObjectIntMap.Entries[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Entries[K]]
  var entries2: com.badlogic.gdx.utils.ObjectIntMap.Entries[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Entries[K]]
  var values1: com.badlogic.gdx.utils.ObjectIntMap.Values = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Values]
  var values2: com.badlogic.gdx.utils.ObjectIntMap.Values = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Values]
  var keys1: com.badlogic.gdx.utils.ObjectIntMap.Keys[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Keys[K]]
  var keys2: com.badlogic.gdx.utils.ObjectIntMap.Keys[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Keys[K]]
  ...
  def put(key: K, value: scala.Int): scala.Unit = {
  ...
  def put(key: K, value: scala.Int, defaultValue: scala.Int): scala.Int = {
    var i: scala.Int = this.locateKey(key)
    if (i >= 0) {
  ...
  def putAll(map: ObjectIntMap[? <: K]): scala.Unit = {
  ...
  private def putResize(key: K, value: scala.Int): scala.Unit = {
    val keyTable: scala.Array[K] = this.keyTable;
    { var i: scala.Int = this.place(key); while (true) { {
      if (keyTable(i) == null) {
        keyTable(i) = key
  ...
  def get(key: K, defaultValue: scala.Int): scala.Int = {
    val i: scala.Int = this.locateKey(key)
    return if (i < 0) defaultValue else this.valueTable(i)
  }
  def getAndIncrement(key: K, defaultValue: scala.Int, increment: scala.Int): scala.Int = {
    var i: scala.Int = this.locateKey(key)
    if (i >= 0) {
      val oldValue: scala.Int = this.valueTable(i)
  ...
  def remove(key$arg: K, defaultValue: scala.Int): scala.Int = {
    var key: K = key$arg
    var i: scala.Int = this.locateKey(key)
    if (i < 0) {
      return defaultValue
  ...
  def entries(): com.badlogic.gdx.utils.ObjectIntMap.Entries[K] = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectIntMap.Entries[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Entries[K]]
    } else ()
    if (this.entries1 == null) {
      this.entries1 = new com.badlogic.gdx.utils.ObjectIntMap.Entries[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Entries[K]]
      this.entries2 = new com.badlogic.gdx.utils.ObjectIntMap.Entries[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Entries[K]]
    } else ()
  ...
  def values(): com.badlogic.gdx.utils.ObjectIntMap.Values = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectIntMap.Values(this)
    } else ()
    if (this.values1 == null) {
      this.values1 = new com.badlogic.gdx.utils.ObjectIntMap.Values(this)
      this.values2 = new com.badlogic.gdx.utils.ObjectIntMap.Values(this)
    } else ()
  ...
  def keys(): com.badlogic.gdx.utils.ObjectIntMap.Keys[K] = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectIntMap.Keys[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Keys[K]]
    } else ()
    if (this.keys1 == null) {
      this.keys1 = new com.badlogic.gdx.utils.ObjectIntMap.Keys[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Keys[K]]
      this.keys2 = new com.badlogic.gdx.utils.ObjectIntMap.Keys[K](this.asInstanceOf[ObjectIntMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectIntMap.Keys[K]]
    } else ()
    if (!this.keys1.valid) {
      this.keys1.reset()
...
object ObjectIntMap {
  ...
  class MapIterator[K](map$p: ObjectIntMap[K]) {
  ...
  class Entries[K](map$p: ObjectIntMap[K]) extends com.badlogic.gdx.utils.ObjectIntMap.MapIterator[K](map$p) with balticporter.runtime.JavaIterable[com.badlogic.gdx.utils.ObjectIntMap.Entry[K]] with balticporter.runtime.JavaIterator[com.badlogic.gdx.utils.ObjectIntMap.Entry[K]] {
  ...
  class Values(map$p: ObjectIntMap[?]) extends com.badlogic.gdx.utils.ObjectIntMap.MapIterator[java.lang.Object](map$p.asInstanceOf[ObjectIntMap[java.lang.Object]]) {
    def hasNext(): scala.Boolean = {
      if (!valid) {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("#iterator() cannot be used nested.")
      } else ()
    ...
    def next(): scala.Int = {
      ...
      val value: scala.Int = this.map.valueTable(nextIndex)
      currentIndex = nextIndex
      this.findNextIndex()
      return value
    }
    def iterator(): com.badlogic.gdx.utils.ObjectIntMap.Values = {
      return this
    }
  ...
  class Keys[K](map$p: ObjectIntMap[K]) extends com.badlogic.gdx.utils.ObjectIntMap.MapIterator[K](map$p) with balticporter.runtime.JavaIterable[K] with balticporter.runtime.JavaIterator[K] {
    def hasNext(): scala.Boolean = {
      if (!valid) {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("#iterator() cannot be used nested.")
      } else ()
