...
class IntMap[V](initialCapacity: scala.Int, loadFactor$p: scala.Float) extends scala.collection.Iterable[com.badlogic.gdx.utils.IntMap.Entry[V]] {
  ...
  private var entries1: com.badlogic.gdx.utils.IntMap.Entries[V] = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Entries[V]]
  private var entries2: com.badlogic.gdx.utils.IntMap.Entries[V] = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Entries[V]]
  private var values1: com.badlogic.gdx.utils.IntMap.Values[V] = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Values[V]]
  private var values2: com.badlogic.gdx.utils.IntMap.Values[V] = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Values[V]]
  private var keys1: com.badlogic.gdx.utils.IntMap.Keys = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Keys]
  private var keys2: com.badlogic.gdx.utils.IntMap.Keys = null.asInstanceOf[com.badlogic.gdx.utils.IntMap.Keys]
  ...
  def putAll(map: IntMap[? <: V]): scala.Unit = {
  ...
  private def putResize(key: scala.Int, value: V): scala.Unit = {
    val keyTable: scala.Array[scala.Int] = this.keyTable;
    { var i: scala.Int = this.place(key); while (true) { {
      if (keyTable(i) == 0) {
        keyTable(i) = key
  ...
  def get(key: scala.Int, defaultValue: V): V = {
    if (key == 0) {
  ...
  def findKey(value: java.lang.Object, identity: scala.Boolean, notFound: scala.Int): scala.Int = {
    val valueTable: scala.Array[V] = this.valueTable
    if (value == null) {
      if (this.hasZeroValue && (this.zeroValue == null)) {
        return 0
  ...
  def equals(obj: java.lang.Object): scala.Boolean = {
    ...
    if (this.hasZeroValue) {
      if (other.asInstanceOf[IntMap[java.lang.Object]].zeroValue == null) {
        if (this.zeroValue != null) {
          return false
        } else ()
      } else {
        if (!other.asInstanceOf[IntMap[java.lang.Object]].zeroValue.equals(this.zeroValue.asInstanceOf[java.lang.Object])) {
          return false
        } else ()
      }
    } else ()
  ...
  def equalsIdentity(obj: java.lang.Object): scala.Boolean = {
    ...
    if (this.hasZeroValue && (this.zeroValue != other.asInstanceOf[IntMap[java.lang.Object]].zeroValue)) {
      return false
    } else ()
    val keyTable: scala.Array[scala.Int] = this.keyTable
    val valueTable: scala.Array[V] = this.valueTable;
  ...
  def iterator(): scala.collection.Iterator[com.badlogic.gdx.utils.IntMap.Entry[V]] = {
    return this.entries()
  }
  ...
  def keys(): com.badlogic.gdx.utils.IntMap.Keys = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.IntMap.Keys(this)
    } else ()
    if (this.keys1 == null) {
      this.keys1 = new com.badlogic.gdx.utils.IntMap.Keys(this)
      this.keys2 = new com.badlogic.gdx.utils.IntMap.Keys(this)
    } else ()
    if (!this.keys1.valid) {
      this.keys1.reset()
...
object IntMap {
  ...
  class MapIterator[V](map$p: IntMap[V]) {
    ...
    def reset(): scala.Unit = {
      this.currentIndex = com.badlogic.gdx.utils.IntMap.MapIterator.INDEX_ILLEGAL
      this.nextIndex = com.badlogic.gdx.utils.IntMap.MapIterator.INDEX_ZERO
    ...
    def remove(): scala.Unit = {
      ...
      if ((i == com.badlogic.gdx.utils.IntMap.MapIterator.INDEX_ZERO) && this.map.hasZeroValue) {
  ...
  class Entries[V](map$p: IntMap[V]) extends com.badlogic.gdx.utils.IntMap.MapIterator[V](map$p) with scala.collection.Iterable[com.badlogic.gdx.utils.IntMap.Entry[V]] with scala.collection.Iterator[com.badlogic.gdx.utils.IntMap.Entry[V]] {
    ...
    def next(): com.badlogic.gdx.utils.IntMap.Entry[V] = {
      ...
      val keyTable: scala.Array[scala.Int] = this.map.keyTable
      if (nextIndex == com.badlogic.gdx.utils.IntMap.MapIterator.INDEX_ZERO) {
        this.entry.key = 0
  ...
  class Values[V](map$p: IntMap[V]) extends com.badlogic.gdx.utils.IntMap.MapIterator[V](map$p) with scala.collection.Iterable[V] with scala.collection.Iterator[V] {
    def hasNext(): scala.Boolean = {
      if (!valid) {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("#iterator() cannot be used nested.")
      } else ()
  ...
  class Keys(map$p: IntMap[?]) extends com.badlogic.gdx.utils.IntMap.MapIterator[scala.AnyRef](map$p) {
    def next(): scala.Int = {
      ...
      val key: scala.Int = if (nextIndex == com.badlogic.gdx.utils.IntMap.MapIterator.INDEX_ZERO) 0 else this.map.keyTable(nextIndex)
      currentIndex = nextIndex
      this.findNextIndex()
      return key
    }
