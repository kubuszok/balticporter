...
class Queue[T] extends scala.collection.Iterable[T] {
  protected var values: scala.Array[T] = null.asInstanceOf[scala.Array[T]]
  protected var head: scala.Int = 0
  protected var tail: scala.Int = 0
  var size: scala.Int = 0
  private var iterable: QueueIterable = null.asInstanceOf[QueueIterable]
  ...
  protected def resize(newSize: scala.Int): scala.Unit = {
    ...
    val newArray: scala.Array[T] = java.util.Arrays.copyOf(values, newSize)
    if (head < tail) {
  ...
  def equals(o: java.lang.Object): scala.Boolean = {
    ...
    val itsValues: scala.Array[java.lang.Object] = q.values
  ...
  class QueueIterable[T] extends scala.collection.Iterable[T] {
    private var queue: Queue[T] = null.asInstanceOf[Queue[T]]
    private var allowRemove: scala.Boolean = false
    private var iterator1: QueueIterator = null.asInstanceOf[QueueIterator]
    private var iterator2: QueueIterator = null.asInstanceOf[QueueIterator]
    def this(queue: Queue[T], allowRemove: scala.Boolean) = {
      this()
      this.queue = queue
      this.allowRemove = allowRemove
