...
class ObjectLongMap[K <: java.lang.Object](initialCapacity: scala.Int, loadFactor$p: scala.Float) extends balticporter.runtime.JavaIterable[com.badlogic.gdx.utils.ObjectLongMap.Entry[K]] {
  ...
  var entries1: com.badlogic.gdx.utils.ObjectLongMap.Entries[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
  var entries2: com.badlogic.gdx.utils.ObjectLongMap.Entries[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
  var values1: com.badlogic.gdx.utils.ObjectLongMap.Values = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Values]
  var values2: com.badlogic.gdx.utils.ObjectLongMap.Values = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Values]
  var keys1: com.badlogic.gdx.utils.ObjectLongMap.Keys[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
  var keys2: com.badlogic.gdx.utils.ObjectLongMap.Keys[K] = null.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
  ...
  this.valueTable = new scala.Array[scala.Long](tableSize)
  ...
  def put(key: K, value: scala.Long): scala.Unit = {
  ...
  def put(key: K, value: scala.Long, defaultValue: scala.Long): scala.Long = {
    var i: scala.Int = this.locateKey(key)
    if (i >= 0) {
      val oldValue: scala.Long = this.valueTable(i)
      this.valueTable(i) = value
      return oldValue
    } else ()
    i = -(i + 1)
  ...
  def putAll(map: ObjectLongMap[? <: K]): scala.Unit = {
    this.ensureCapacity(map.size)
    val keyTable: scala.Array[K] = map.keyTable.asInstanceOf[scala.Array[K]]
    val valueTable: scala.Array[scala.Long] = map.valueTable
  ...
  private def putResize(key: K, value: scala.Long): scala.Unit = {
    val keyTable: scala.Array[K] = this.keyTable;
    { var i: scala.Int = this.place(key); while (true) { {
      if (keyTable(i) == null) {
        keyTable(i) = key
  ...
  def get(key: K, defaultValue: scala.Long): scala.Long = {
    val i: scala.Int = this.locateKey(key)
    return if (i < 0) defaultValue else this.valueTable(i)
  }
  def getAndIncrement(key: K, defaultValue: scala.Long, increment: scala.Long): scala.Long = {
    var i: scala.Int = this.locateKey(key)
    if (i >= 0) {
      val oldValue: scala.Long = this.valueTable(i)
  ...
  def remove(key$arg: K, defaultValue: scala.Long): scala.Long = {
    var key: K = key$arg
    var i: scala.Int = this.locateKey(key)
    if (i < 0) {
      return defaultValue
    ...
    val oldValue: scala.Long = valueTable(i)
  ...
  def containsValue(value: scala.Long): scala.Boolean = {
    val keyTable: scala.Array[K] = this.keyTable
    val valueTable: scala.Array[scala.Long] = this.valueTable;
  ...
  def equals(obj: java.lang.Object): scala.Boolean = {
    ...
    { var i: scala.Int = 0; val n: scala.Int = keyTable.length; while (i < n) { {
      val key: K = keyTable(i)
      if (key != null) {
        val otherValue: scala.Long = other.asInstanceOf[ObjectLongMap[java.lang.Object]].get(key.asInstanceOf[java.lang.Object], 0)
        if ((otherValue == 0) && (!other.asInstanceOf[ObjectLongMap[java.lang.Object]].containsKey(key.asInstanceOf[java.lang.Object]))) {
          return false
        } else ()
  ...
  def entries(): com.badlogic.gdx.utils.ObjectLongMap.Entries[K] = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectLongMap.Entries[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
    } else ()
    if (this.entries1 == null) {
      this.entries1 = new com.badlogic.gdx.utils.ObjectLongMap.Entries[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
      this.entries2 = new com.badlogic.gdx.utils.ObjectLongMap.Entries[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
    } else ()
    if (!this.entries1.valid) {
      this.entries1.reset()
      this.entries1.valid = true
      this.entries2.valid = false
      return this.entries1.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
    } else ()
    this.entries2.reset()
    this.entries2.valid = true
    this.entries1.valid = false
    return this.entries2.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Entries[K]]
  }
  def values(): com.badlogic.gdx.utils.ObjectLongMap.Values = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectLongMap.Values(this)
    } else ()
    if (this.values1 == null) {
      this.values1 = new com.badlogic.gdx.utils.ObjectLongMap.Values(this)
      this.values2 = new com.badlogic.gdx.utils.ObjectLongMap.Values(this)
    } else ()
  ...
  def keys(): com.badlogic.gdx.utils.ObjectLongMap.Keys[K] = {
    if (com.badlogic.gdx.utils.Collections.allocateIterators) {
      return new com.badlogic.gdx.utils.ObjectLongMap.Keys[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
    } else ()
    if (this.keys1 == null) {
      this.keys1 = new com.badlogic.gdx.utils.ObjectLongMap.Keys[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
      this.keys2 = new com.badlogic.gdx.utils.ObjectLongMap.Keys[K](this.asInstanceOf[ObjectLongMap[K]]).asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
    } else ()
    if (!this.keys1.valid) {
      this.keys1.reset()
      this.keys1.valid = true
      this.keys2.valid = false
      return this.keys1.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
    } else ()
    this.keys2.reset()
    this.keys2.valid = true
    this.keys1.valid = false
    return this.keys2.asInstanceOf[com.badlogic.gdx.utils.ObjectLongMap.Keys[K]]
  }
}
object ObjectLongMap {
  ...
  class MapIterator[K <: java.lang.Object](map$p: ObjectLongMap[K]) {
    ...
    def remove(): scala.Unit = {
      ...
      val keyTable: scala.Array[K] = this.map.keyTable
      val valueTable: scala.Array[scala.Long] = this.map.valueTable
  ...
  class Values(map$p: ObjectLongMap[?]) extends com.badlogic.gdx.utils.ObjectLongMap.MapIterator[java.lang.Object](map$p.asInstanceOf[ObjectLongMap[java.lang.Object]]) {
    def hasNext(): scala.Boolean = {
      if (!valid) {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("#iterator() cannot be used nested.")
      } else ()
    ...
    def next(): scala.Long = {
      ...
      val value: scala.Long = this.map.valueTable(nextIndex)
      currentIndex = nextIndex
      this.findNextIndex()
      return value
    }
    def iterator(): com.badlogic.gdx.utils.ObjectLongMap.Values = {
      return this
    }
  ...
  class Keys[K <: java.lang.Object](map$p: ObjectLongMap[K]) extends com.badlogic.gdx.utils.ObjectLongMap.MapIterator[K](map$p) with balticporter.runtime.JavaIterable[K] with balticporter.runtime.JavaIterator[K] {
    def hasNext(): scala.Boolean = {
      if (!valid) {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("#iterator() cannot be used nested.")
      } else ()
    ...
    def iterator(): com.badlogic.gdx.utils.ObjectLongMap.Keys[K] = {
      return this
    }
