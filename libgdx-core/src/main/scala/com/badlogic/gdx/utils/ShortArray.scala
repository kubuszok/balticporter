...
class ShortArray {
  var items: scala.Array[scala.Short] = null.asInstanceOf[scala.Array[scala.Short]]
  var size: scala.Int = 0
  var ordered: scala.Boolean = false
  def this(ordered: scala.Boolean, capacity: scala.Int) = {
    this()
    this.ordered = ordered
    this.items = new scala.Array[scala.Short](capacity)
  }
  def this(capacity: scala.Int) = {
    this(true, capacity)
  }
  def this(array: ShortArray) = {
    this()
    this.ordered = array.ordered
    this.size = array.size
    this.items = new scala.Array[scala.Short](this.size)
    java.lang.System.arraycopy(array.items, 0, this.items, 0, this.size)
  }
  def this(ordered: scala.Boolean, array: scala.Array[scala.Short], startIndex: scala.Int, count: scala.Int) = {
    this(ordered, count)
    this.size = count
  ...
  def addAll(array: ShortArray): scala.Unit = {
    this.addAll(array.items, 0, array.size)
  }
  def addAll(array: ShortArray, offset: scala.Int, length: scala.Int): scala.Unit = {
    if ((offset + length) > array.size) {
      throw new java.lang.IllegalArgumentException((((("offset + length must be <= size: " + offset) + " + ") + length) + " <= ") + array.size)
    } else ()
    this.addAll(array.items, offset, length)
  }
  def addAll(array: scala.Array[scala.Short]): scala.Unit = {
    this.addAll(array, 0, array.length)
  }
  def addAll(array: scala.Array[scala.Short], offset: scala.Int, length: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Short] = this.items
  ...
  def get(index: scala.Int): scala.Short = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    return this.items(index)
  }
  def set(index: scala.Int, value: scala.Short): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = value
  }
  def incr(index: scala.Int, value: scala.Short): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
  ...
  def swap(first: scala.Int, second: scala.Int): scala.Unit = {
    ...
    val items: scala.Array[scala.Short] = this.items
    val firstValue: scala.Short = items(first)
  ...
  def contains(value: scala.Short): scala.Boolean = {
  ...
  def removeIndex(index: scala.Int): scala.Short = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    val items: scala.Array[scala.Short] = this.items
    val value: scala.Short = items(index)
    this.size = this.size - 1
    if (this.ordered) {
  ...
  def peek(): scala.Short = {
    return this.items(this.size - 1)
  }
  def first(): scala.Short = {
    if (this.size == 0) {
  ...
  def shrink(): scala.Array[scala.Short] = {
    if (this.items.length != this.size) {
      this.resize(this.size)
    } else ()
    return this.items
  }
  def ensureCapacity(additionalCapacity: scala.Int): scala.Array[scala.Short] = {
  ...
  def setSize(newSize: scala.Int): scala.Array[scala.Short] = {
    if (newSize < 0) {
  ...
  def resize(newSize: scala.Int): scala.Array[scala.Short] = {
    val newItems: scala.Array[scala.Short] = new scala.Array[scala.Short](newSize)
    var items: scala.Array[scala.Short] = this.items
...
object ShortArray {
  def `with`(array: scala.Array[scala.Short]): ShortArray = {
