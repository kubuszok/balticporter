...
class ByteArray {
  var items: scala.Array[scala.Byte] = null.asInstanceOf[scala.Array[scala.Byte]]
  ...
  def addAll(array: ByteArray): scala.Unit = {
    this.addAll(array.items, 0, array.size)
  }
  def addAll(array: ByteArray, offset: scala.Int, length: scala.Int): scala.Unit = {
    if ((offset + length) > array.size) {
      throw new java.lang.IllegalArgumentException((((("offset + length must be <= size: " + offset) + " + ") + length) + " <= ") + array.size)
    } else ()
    this.addAll(array.items, offset, length)
  }
  def addAll(array: scala.Array[scala.Byte]): scala.Unit = {
    this.addAll(array, 0, array.length)
  }
  def addAll(array: scala.Array[scala.Byte], offset: scala.Int, length: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Byte] = this.items
  ...
  def get(index: scala.Int): scala.Byte = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    return this.items(index)
  }
  def set(index: scala.Int, value: scala.Byte): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = value
  }
  def incr(index: scala.Int, value: scala.Byte): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
  ...
  def swap(first: scala.Int, second: scala.Int): scala.Unit = {
    ...
    val items: scala.Array[scala.Byte] = this.items
    val firstValue: scala.Byte = items(first)
    items(first) = items(second)
    items(second) = firstValue
  }
  def replaceFirst(value: scala.Byte, replacement: scala.Byte): scala.Boolean = {
    val items: scala.Array[scala.Byte] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        items(i) = replacement
  ...
  def replaceAll(value: scala.Byte, replacement: scala.Byte): scala.Int = {
    val items: scala.Array[scala.Byte] = this.items
  ...
  def contains(value: scala.Byte): scala.Boolean = {
  ...
  def indexOf(value: scala.Byte): scala.Int = {
    val items: scala.Array[scala.Byte] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        return i
  ...
  def lastIndexOf(value: scala.Byte): scala.Int = {
    val items: scala.Array[scala.Byte] = this.items
  ...
  def removeValue(value: scala.Byte): scala.Boolean = {
    val items: scala.Array[scala.Byte] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        this.removeIndex(i)
  ...
  def removeAll(array: ByteArray): scala.Boolean = {
  ...
  def shrink(): scala.Array[scala.Byte] = {
    if (this.items.length != this.size) {
      this.resize(this.size)
    } else ()
    return this.items
  }
  def ensureCapacity(additionalCapacity: scala.Int): scala.Array[scala.Byte] = {
  ...
  def setSize(newSize: scala.Int): scala.Array[scala.Byte] = {
    if (newSize < 0) {
  ...
  protected def resize(newSize: scala.Int): scala.Array[scala.Byte] = {
  ...
  def equals(`object`: java.lang.Object): scala.Boolean = {
    ...
    val items1: scala.Array[scala.Byte] = this.items
    val items2: scala.Array[scala.Byte] = array.items
...
object ByteArray {
  def `with`(array: scala.Array[scala.Byte]): ByteArray = {
