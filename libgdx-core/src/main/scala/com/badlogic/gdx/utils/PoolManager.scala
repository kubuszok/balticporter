...
class PoolManager {
  ...
  def getPool[T](clazz: java.lang.Class[T]): com.badlogic.gdx.utils.Pool[T] = {
  ...
  def getPoolOrNull[T](clazz: java.lang.Class[T]): com.badlogic.gdx.utils.Pool[T] = {
  ...
  def obtain[T](clazz: java.lang.Class[T]): T = {
    val pool: com.badlogic.gdx.utils.Pool[T] = this.typePools.get(clazz).asInstanceOf[com.badlogic.gdx.utils.Pool[T]]
    if (pool == null) {
