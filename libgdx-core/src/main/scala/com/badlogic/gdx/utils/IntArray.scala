...
class IntArray {
  var items: scala.Array[scala.Int] = null.asInstanceOf[scala.Array[scala.Int]]
  var size: scala.Int = 0
  var ordered: scala.Boolean = false
  def this(ordered: scala.Boolean, capacity: scala.Int) = {
    this()
    this.ordered = ordered
    this.items = new Array[scala.Int](capacity)
  }
  def this(array: IntArray) = {
    this()
    this.ordered = array.ordered
    this.size = array.size
    this.items = new Array[scala.Int](this.size)
    java.lang.System.arraycopy(array.items, 0, this.items, 0, this.size)
  }
  def this(ordered: scala.Boolean, array: scala.Array[scala.Int], startIndex: scala.Int, count: scala.Int) = {
    this(ordered, count)
    this.size = count
  ...
  def add(value1: scala.Int, value2: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Int] = this.items
  ...
  def add(value1: scala.Int, value2: scala.Int, value3: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Int] = this.items
  ...
  def add(value1: scala.Int, value2: scala.Int, value3: scala.Int, value4: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Int] = this.items
  ...
  def addAll(array: IntArray): scala.Unit = {
    this.addAll(array.items, 0, array.size)
  }
  def addAll(array: IntArray, offset: scala.Int, length: scala.Int): scala.Unit = {
  ...
  def get(index: scala.Int): scala.Int = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    return this.items(index)
  }
  def set(index: scala.Int, value: scala.Int): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = value
  }
  def incr(index: scala.Int, value: scala.Int): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = this.items(index) + value
  }
  def incr(value: scala.Int): scala.Unit = {
    val items: scala.Array[scala.Int] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      items(i) = items(i) + value
    }; i = i + 1 } }
  }
  def mul(index: scala.Int, value: scala.Int): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = this.items(index) * value
  }
  def mul(value: scala.Int): scala.Unit = {
    val items: scala.Array[scala.Int] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      items(i) = items(i) * value
    }; i = i + 1 } }
  }
  def insert(index: scala.Int, value: scala.Int): scala.Unit = {
    if (index > this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be > size: " + index) + " > ") + this.size)
    } else ()
    var items: scala.Array[scala.Int] = this.items
  ...
  def swap(first: scala.Int, second: scala.Int): scala.Unit = {
    ...
    val items: scala.Array[scala.Int] = this.items
    val firstValue: scala.Int = items(first)
    items(first) = items(second)
    items(second) = firstValue
  }
  def replaceFirst(value: scala.Int, replacement: scala.Int): scala.Boolean = {
    val items: scala.Array[scala.Int] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        items(i) = replacement
  ...
  def replaceAll(value: scala.Int, replacement: scala.Int): scala.Int = {
    val items: scala.Array[scala.Int] = this.items
  ...
  def contains(value: scala.Int): scala.Boolean = {
  ...
  def indexOf(value: scala.Int): scala.Int = {
    val items: scala.Array[scala.Int] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        return i
  ...
  def lastIndexOf(value: scala.Int): scala.Int = {
    val items: scala.Array[scala.Int] = this.items
  ...
  def removeValue(value: scala.Int): scala.Boolean = {
    val items: scala.Array[scala.Int] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        this.removeIndex(i)
  ...
  def removeIndex(index: scala.Int): scala.Int = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    val items: scala.Array[scala.Int] = this.items
    val value: scala.Int = items(index)
    this.size = this.size - 1
    if (this.ordered) {
  ...
  def shrink(): scala.Array[scala.Int] = {
    if (this.items.length != this.size) {
      this.resize(this.size)
    } else ()
    return this.items
  }
  def ensureCapacity(additionalCapacity: scala.Int): scala.Array[scala.Int] = {
  ...
  def setSize(newSize: scala.Int): scala.Array[scala.Int] = {
    if (newSize < 0) {
  ...
  protected def resize(newSize: scala.Int): scala.Array[scala.Int] = {
    val newItems: scala.Array[scala.Int] = new Array[scala.Int](newSize)
    var items: scala.Array[scala.Int] = this.items
  ...
  def toArray(): scala.Array[scala.Int] = {
    val array: scala.Array[scala.Int] = new Array[scala.Int](this.size)
  ...
  def equals(`object`: java.lang.Object): scala.Boolean = {
    ...
    val items1: scala.Array[scala.Int] = this.items
    val items2: scala.Array[scala.Int] = array.items
...
object IntArray {
  def `with`(array: scala.Array[scala.Int]): IntArray = {
