...
class BooleanArray {
  var items: scala.Array[scala.Boolean] = null.asInstanceOf[scala.Array[scala.Boolean]]
  ...
  def add(value1: scala.Boolean, value2: scala.Boolean): scala.Unit = {
    var items: scala.Array[scala.Boolean] = this.items
  ...
  def add(value1: scala.Boolean, value2: scala.Boolean, value3: scala.Boolean): scala.Unit = {
    var items: scala.Array[scala.Boolean] = this.items
  ...
  def add(value1: scala.Boolean, value2: scala.Boolean, value3: scala.Boolean, value4: scala.Boolean): scala.Unit = {
    var items: scala.Array[scala.Boolean] = this.items
  ...
  def addAll(array: BooleanArray): scala.Unit = {
    this.addAll(array.items, 0, array.size)
  }
  def addAll(array: BooleanArray, offset: scala.Int, length: scala.Int): scala.Unit = {
    if ((offset + length) > array.size) {
      throw new java.lang.IllegalArgumentException((((("offset + length must be <= size: " + offset) + " + ") + length) + " <= ") + array.size)
    } else ()
    this.addAll(array.items, offset, length)
  }
  def addAll(array: scala.Array[scala.Boolean]): scala.Unit = {
    this.addAll(array, 0, array.length)
  }
  def addAll(array: scala.Array[scala.Boolean], offset: scala.Int, length: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Boolean] = this.items
  ...
  def set(index: scala.Int, value: scala.Boolean): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = value
  }
  def insert(index: scala.Int, value: scala.Boolean): scala.Unit = {
    if (index > this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be > size: " + index) + " > ") + this.size)
    } else ()
    var items: scala.Array[scala.Boolean] = this.items
  ...
  def swap(first: scala.Int, second: scala.Int): scala.Unit = {
    ...
    val firstValue: scala.Boolean = items(first)
  ...
  def removeIndex(index: scala.Int): scala.Boolean = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    val items: scala.Array[scala.Boolean] = this.items
    val value: scala.Boolean = items(index)
    this.size = this.size - 1
    if (this.ordered) {
  ...
  def pop(): scala.Boolean = {
    return this.items({ this.size -= 1; this.size })
  }
  def peek(): scala.Boolean = {
  ...
  def shrink(): scala.Array[scala.Boolean] = {
    if (this.items.length != this.size) {
      this.resize(this.size)
    } else ()
    return this.items
  }
  def ensureCapacity(additionalCapacity: scala.Int): scala.Array[scala.Boolean] = {
  ...
  def setSize(newSize: scala.Int): scala.Array[scala.Boolean] = {
    if (newSize < 0) {
...
object BooleanArray {
  def `with`(array: scala.Array[scala.Boolean]): BooleanArray = {
