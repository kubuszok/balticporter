...
object QuadTreeFloat {
  ...
  private final val pool: com.badlogic.gdx.utils.Pool[QuadTreeFloat] = new com.badlogic.gdx.utils.Pool(128, 4096).asInstanceOf[com.badlogic.gdx.utils.Pool[QuadTreeFloat]]
}