...
class ObjectFloatMap[K <: java.lang.Object](initialCapacity: scala.Int, loadFactor$p: scala.Float) extends balticporter.runtime.JavaIterable[com.badlogic.gdx.utils.ObjectFloatMap.Entry[K]] {
  ...
  override def iterator(): com.badlogic.gdx.utils.ObjectFloatMap.Entries[K] = {
    return this.entries()
  }
  def entries(): com.badlogic.gdx.utils.ObjectFloatMap.Entries[K] = {
    ...
    if (!this.entries1.valid) {
      ...
      return this.entries1.asInstanceOf[com.badlogic.gdx.utils.ObjectFloatMap.Entries[K]]
    } else ()
    this.entries2.reset()
    this.entries2.valid = true
    this.entries1.valid = false
    return this.entries2.asInstanceOf[com.badlogic.gdx.utils.ObjectFloatMap.Entries[K]]
  }
  ...
  def keys(): com.badlogic.gdx.utils.ObjectFloatMap.Keys[K] = {
    ...
    if (!this.keys1.valid) {
      ...
      return this.keys1.asInstanceOf[com.badlogic.gdx.utils.ObjectFloatMap.Keys[K]]
    } else ()
    this.keys2.reset()
    this.keys2.valid = true
    this.keys1.valid = false
    return this.keys2.asInstanceOf[com.badlogic.gdx.utils.ObjectFloatMap.Keys[K]]
  }
}
object ObjectFloatMap {
  ...
  class Entries[K <: java.lang.Object](map$p: ObjectFloatMap[K]) extends com.badlogic.gdx.utils.ObjectFloatMap.MapIterator[K](map$p) with balticporter.runtime.JavaIterable[com.badlogic.gdx.utils.ObjectFloatMap.Entry[K]] with balticporter.runtime.JavaIterator[com.badlogic.gdx.utils.ObjectFloatMap.Entry[K]] {
    ...
    override def next(): com.badlogic.gdx.utils.ObjectFloatMap.Entry[K] = {
      if (!hasNext$field) {
  ...
  class Values(map$p: ObjectFloatMap[?]) extends com.badlogic.gdx.utils.ObjectFloatMap.MapIterator[java.lang.Object](map$p.asInstanceOf[ObjectFloatMap[java.lang.Object]]) {
  ...
  class Keys[K <: java.lang.Object](map$p: ObjectFloatMap[K]) extends com.badlogic.gdx.utils.ObjectFloatMap.MapIterator[K](map$p) with balticporter.runtime.JavaIterable[K] with balticporter.runtime.JavaIterator[K] {
    ...
    override def iterator(): com.badlogic.gdx.utils.ObjectFloatMap.Keys[K] = {
      return this
    }
