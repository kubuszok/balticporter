...
class ArrayMap[K, V] extends scala.collection.Iterable[com.badlogic.gdx.utils.ObjectMap#Entry[K, V]] {
  ...
  def this(ordered: scala.Boolean, capacity: scala.Int, keyArraySupplier: com.badlogic.gdx.utils.ArraySupplier[scala.Array[K]], valueArraySupplier: com.badlogic.gdx.utils.ArraySupplier[scala.Array[V]]) = {
    ...
    this.keys$field = keyArraySupplier.get(capacity)
    this.values$field = valueArraySupplier.get(capacity)
  }
  def this(array: ArrayMap[K, V]) = {
    this()
    this.ordered = array.ordered
    this.keys$field = java.util.Arrays.copyOf(array.keys$field, array.keys$field.length)
    this.values$field = java.util.Arrays.copyOf(array.values$field, array.values$field.length)
  ...
  def put(key: K, value: V): scala.Int = {
    ...
    if (index == (-1)) {
      if (this.size == this.keys$field.length) {
        this.resize(java.lang.Math.max(8, (this.size * 1.75f).asInstanceOf[scala.Int]))
      } else ()
  ...
  def putAll(map: ArrayMap[? <: K, ? <: V], offset: scala.Int, length: scala.Int): scala.Unit = {
    ...
    if (sizeNeeded >= this.keys$field.length) {
      this.resize(java.lang.Math.max(8, (sizeNeeded * 1.75f).asInstanceOf[scala.Int]))
    } else ()
  ...
  def get(key: K, defaultValue: V): V = {
    val keys: scala.Array[java.lang.Object] = this.keys$field
  ...
  def getKey(value: V, identity: scala.Boolean): K = {
    val values: scala.Array[java.lang.Object] = this.values$field
    var i: scala.Int = this.size - 1
  ...
  def removeIndex(index: scala.Int): scala.Unit = {
    ...
    keys(this.size) = null
    this.values$field(this.size) = null
  }
  ...
  protected def resize(newSize: scala.Int): scala.Unit = {
    this.keys$field = java.util.Arrays.copyOf(this.keys$field, newSize)
    this.values$field = java.util.Arrays.copyOf(this.values$field, newSize)
  }
  ...
  def truncate(newSize: scala.Int): scala.Unit = {
    ...
    { var i: scala.Int = newSize; while (i < this.size) { {
      this.keys$field(i) = null
      this.values$field(i) = null
    }; i = i + 1 } }
    this.size = newSize
  }
  ...
  def equals(obj: java.lang.Object): scala.Boolean = {
    ...
    val other: ArrayMap = obj.asInstanceOf[ArrayMap]
