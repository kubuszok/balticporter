...
class FloatArray {
  var items: scala.Array[scala.Float] = null.asInstanceOf[scala.Array[scala.Float]]
  ...
  def add(value1: scala.Float, value2: scala.Float): scala.Unit = {
    var items: scala.Array[scala.Float] = this.items
  ...
  def add(value1: scala.Float, value2: scala.Float, value3: scala.Float): scala.Unit = {
    var items: scala.Array[scala.Float] = this.items
  ...
  def add(value1: scala.Float, value2: scala.Float, value3: scala.Float, value4: scala.Float): scala.Unit = {
    var items: scala.Array[scala.Float] = this.items
  ...
  def addAll(array: FloatArray): scala.Unit = {
    this.addAll(array.items, 0, array.size)
  }
  def addAll(array: FloatArray, offset: scala.Int, length: scala.Int): scala.Unit = {
    if ((offset + length) > array.size) {
      throw new java.lang.IllegalArgumentException((((("offset + length must be <= size: " + offset) + " + ") + length) + " <= ") + array.size)
    } else ()
    this.addAll(array.items, offset, length)
  }
  def addAll(array: scala.Array[scala.Float]): scala.Unit = {
    this.addAll(array, 0, array.length)
  }
  def addAll(array: scala.Array[scala.Float], offset: scala.Int, length: scala.Int): scala.Unit = {
    var items: scala.Array[scala.Float] = this.items
  ...
  def get(index: scala.Int): scala.Float = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    return this.items(index)
  }
  def set(index: scala.Int, value: scala.Float): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = value
  }
  def incr(index: scala.Int, value: scala.Float): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = this.items(index) + value
  }
  def incr(value: scala.Float): scala.Unit = {
    val items: scala.Array[scala.Float] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      items(i) = items(i) + value
    }; i = i + 1 } }
  }
  def mul(index: scala.Int, value: scala.Float): scala.Unit = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    this.items(index) = this.items(index) * value
  }
  def mul(value: scala.Float): scala.Unit = {
    val items: scala.Array[scala.Float] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      items(i) = items(i) * value
    }; i = i + 1 } }
  }
  def insert(index: scala.Int, value: scala.Float): scala.Unit = {
    if (index > this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be > size: " + index) + " > ") + this.size)
    } else ()
    var items: scala.Array[scala.Float] = this.items
  ...
  def swap(first: scala.Int, second: scala.Int): scala.Unit = {
    ...
    val items: scala.Array[scala.Float] = this.items
    val firstValue: scala.Float = items(first)
    items(first) = items(second)
    items(second) = firstValue
  }
  def replaceFirst(value: scala.Float, replacement: scala.Float): scala.Boolean = {
    val items: scala.Array[scala.Float] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        items(i) = replacement
  ...
  def replaceAll(value: scala.Float, replacement: scala.Float): scala.Int = {
    val items: scala.Array[scala.Float] = this.items
  ...
  def contains(value: scala.Float): scala.Boolean = {
  ...
  def indexOf(value: scala.Float): scala.Int = {
    val items: scala.Array[scala.Float] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        return i
  ...
  def lastIndexOf(value: scala.Float): scala.Int = {
    val items: scala.Array[scala.Float] = this.items
  ...
  def removeValue(value: scala.Float): scala.Boolean = {
    val items: scala.Array[scala.Float] = this.items
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      if (items(i) == value) {
        this.removeIndex(i)
  ...
  def removeIndex(index: scala.Int): scala.Float = {
    if (index >= this.size) {
      throw new java.lang.IndexOutOfBoundsException((("index can't be >= size: " + index) + " >= ") + this.size)
    } else ()
    val items: scala.Array[scala.Float] = this.items
    val value: scala.Float = items(index)
    this.size = this.size - 1
    if (this.ordered) {
  ...
  def peek(): scala.Float = {
    return this.items(this.size - 1)
  }
  def first(): scala.Float = {
    if (this.size == 0) {
  ...
  def shrink(): scala.Array[scala.Float] = {
    if (this.items.length != this.size) {
      this.resize(this.size)
    } else ()
    return this.items
  }
  def ensureCapacity(additionalCapacity: scala.Int): scala.Array[scala.Float] = {
  ...
  def setSize(newSize: scala.Int): scala.Array[scala.Float] = {
    if (newSize < 0) {
  ...
  protected def resize(newSize: scala.Int): scala.Array[scala.Float] = {
  ...
  def hashCode(): scala.Int = {
    ...
    var h: scala.Int = 1
    { var i: scala.Int = 0; val n: scala.Int = this.size; while (i < n) { {
      h = (h * 31) + com.badlogic.gdx.utils.NumberUtils.floatToRawIntBits(items(i))
    }; i = i + 1 } }
    return h
  }
  def equals(`object`: java.lang.Object): scala.Boolean = {
    ...
    val items1: scala.Array[scala.Float] = this.items
    val items2: scala.Array[scala.Float] = array.items
  ...
  def equals(`object`: java.lang.Object, epsilon: scala.Float): scala.Boolean = {
    if (`object` == this) {
      return true
    } else ()
    if (!`object`.isInstanceOf[FloatArray]) {
    ...
    val items2: scala.Array[scala.Float] = array.items
    { var i: scala.Int = 0; while (i < n) { {
      if (java.lang.Math.abs(items1(i) - items2(i)) > epsilon) {
        return false
      } else ()
    }; i = i + 1 } }
    return true
...
object FloatArray {
  def `with`(array: scala.Array[scala.Float]): FloatArray = {
