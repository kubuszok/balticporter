...
object Matrix4 {
  ...
  def prj(mat: scala.Array[scala.Float], vecs: scala.Array[scala.Float], offset: scala.Int, numVecs: scala.Int, stride: scala.Int): scala.Unit = { prj$29090$handle.invokeExact(mat, vecs, offset, numVecs, stride); () }
