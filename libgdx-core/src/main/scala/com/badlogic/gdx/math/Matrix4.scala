...
object Matrix4 {
  ...
  private val mulVec$31360$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("mulVec").orElseThrow(), java.lang.foreign.FunctionDescriptor.ofVoid(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val prj$29468$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("prj").orElseThrow(), java.lang.foreign.FunctionDescriptor.ofVoid(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val rot$31371$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("rot").orElseThrow(), java.lang.foreign.FunctionDescriptor.ofVoid(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  def mulVec(mat: scala.Array[scala.Float], vecs: scala.Array[scala.Float], offset: scala.Int, numVecs: scala.Int, stride: scala.Int): scala.Unit = { mulVec$31360$handle.invokeExact(mat, vecs, offset, numVecs, stride); () }
  def prj(mat: scala.Array[scala.Float], vecs: scala.Array[scala.Float], offset: scala.Int, numVecs: scala.Int, stride: scala.Int): scala.Unit = { prj$29468$handle.invokeExact(mat, vecs, offset, numVecs, stride); () }
  def rot(mat: scala.Array[scala.Float], vecs: scala.Array[scala.Float], offset: scala.Int, numVecs: scala.Int, stride: scala.Int): scala.Unit = { rot$31371$handle.invokeExact(mat, vecs, offset, numVecs, stride); () }
