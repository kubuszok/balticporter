...
class DefaultShaderProvider(config$p: com.badlogic.gdx.graphics.g3d.shaders.DefaultShader.Config) extends com.badlogic.gdx.graphics.g3d.utils.BaseShaderProvider {
  ...
  this.config = if (config$p == null) new com.badlogic.gdx.graphics.g3d.shaders.DefaultShader.Config() else config$p
  @java.lang.Override
