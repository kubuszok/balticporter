...
class BillboardParticleBatch(mode$p: com.badlogic.gdx.graphics.g3d.particles.ParticleShader.AlignMode, useGPU$p: scala.Boolean, capacity: scala.Int, blendingAttribute$p: com.badlogic.gdx.graphics.g3d.attributes.BlendingAttribute, depthTestAttribute$p: com.badlogic.gdx.graphics.g3d.attributes.DepthTestAttribute) extends com.badlogic.gdx.graphics.g3d.particles.batches.BufferedParticleBatch[com.badlogic.gdx.graphics.g3d.particles.renderers.BillboardControllerRenderData](((size: scala.Int) => new scala.Array[com.badlogic.gdx.graphics.g3d.particles.renderers.BillboardControllerRenderData](size))) {
  ...
  def allocRenderable(): com.badlogic.gdx.graphics.g3d.Renderable = {
    ...
    renderable.material = new com.badlogic.gdx.graphics.g3d.Material(scala.Array[com.badlogic.gdx.graphics.g3d.Attribute](this.blendingAttribute, this.depthTestAttribute, com.badlogic.gdx.graphics.g3d.attributes.TextureAttribute.createDiffuse(this.texture)))
...
object BillboardParticleBatch {
  ...
  private final val GPU_ATTRIBUTES: com.badlogic.gdx.graphics.VertexAttributes = new com.badlogic.gdx.graphics.VertexAttributes(scala.Array[com.badlogic.gdx.graphics.VertexAttribute](new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.Position, 3, com.badlogic.gdx.graphics.glutils.ShaderProgram.POSITION_ATTRIBUTE), new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.TextureCoordinates, 2, com.badlogic.gdx.graphics.glutils.ShaderProgram.TEXCOORD_ATTRIBUTE + "0"), new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.ColorUnpacked, 4, com.badlogic.gdx.graphics.glutils.ShaderProgram.COLOR_ATTRIBUTE), new com.badlogic.gdx.graphics.VertexAttribute(BillboardParticleBatch.sizeAndRotationUsage, 4, "a_sizeAndRotation")))
  private final val CPU_ATTRIBUTES: com.badlogic.gdx.graphics.VertexAttributes = new com.badlogic.gdx.graphics.VertexAttributes(scala.Array[com.badlogic.gdx.graphics.VertexAttribute](new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.Position, 3, com.badlogic.gdx.graphics.glutils.ShaderProgram.POSITION_ATTRIBUTE), new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.TextureCoordinates, 2, com.badlogic.gdx.graphics.glutils.ShaderProgram.TEXCOORD_ATTRIBUTE + "0"), new com.badlogic.gdx.graphics.VertexAttribute(com.badlogic.gdx.graphics.VertexAttributes.Usage.ColorUnpacked, 4, com.badlogic.gdx.graphics.glutils.ShaderProgram.COLOR_ATTRIBUTE)))
