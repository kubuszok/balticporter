...
object ETC1 {
  ...
  private val getCompressedDataSize$20244$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("getCompressedDataSize").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val formatHeader$20247$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("formatHeader").orElseThrow(), java.lang.foreign.FunctionDescriptor.ofVoid(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val getWidthPKM$20238$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("getWidthPKM").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT))
  private val getHeightPKM$20240$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("getHeightPKM").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT))
  private val isValidPKM$20256$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("isValidPKM").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.JAVA_BOOLEAN, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT))
  private val decodeImage$20243$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("decodeImage").orElseThrow(), java.lang.foreign.FunctionDescriptor.ofVoid(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val encodeImage$20221$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("encodeImage").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  private val encodeImagePKM$20228$handle: java.lang.invoke.MethodHandle = java.lang.foreign.Linker.nativeLinker().downcallHandle(java.lang.foreign.Linker.nativeLinker().defaultLookup().find("encodeImagePKM").orElseThrow(), java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.ADDRESS, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT, java.lang.foreign.ValueLayout.JAVA_INT))
  ...
  def getCompressedDataSize(width: scala.Int, height: scala.Int): scala.Int = getCompressedDataSize$20244$handle.invokeExact(width, height).asInstanceOf[scala.Int]
  def formatHeader(header: java.nio.ByteBuffer, offset: scala.Int, width: scala.Int, height: scala.Int): scala.Unit = { formatHeader$20247$handle.invokeExact(header, offset, width, height); () }
  def getWidthPKM(header: java.nio.ByteBuffer, offset: scala.Int): scala.Int = getWidthPKM$20238$handle.invokeExact(header, offset).asInstanceOf[scala.Int]
  def getHeightPKM(header: java.nio.ByteBuffer, offset: scala.Int): scala.Int = getHeightPKM$20240$handle.invokeExact(header, offset).asInstanceOf[scala.Int]
  def isValidPKM(header: java.nio.ByteBuffer, offset: scala.Int): scala.Boolean = isValidPKM$20256$handle.invokeExact(header, offset).asInstanceOf[scala.Boolean]
  private def decodeImage(compressedData: java.nio.ByteBuffer, offset: scala.Int, decodedData: java.nio.ByteBuffer, offsetDec: scala.Int, width: scala.Int, height: scala.Int, pixelSize: scala.Int): scala.Unit = { decodeImage$20243$handle.invokeExact(compressedData, offset, decodedData, offsetDec, width, height, pixelSize); () }
  private def encodeImage(imageData: java.nio.ByteBuffer, offset: scala.Int, width: scala.Int, height: scala.Int, pixelSize: scala.Int): java.nio.ByteBuffer = encodeImage$20221$handle.invokeExact(imageData, offset, width, height, pixelSize).asInstanceOf[java.nio.ByteBuffer]
  private def encodeImagePKM(imageData: java.nio.ByteBuffer, offset: scala.Int, width: scala.Int, height: scala.Int, pixelSize: scala.Int): java.nio.ByteBuffer = encodeImagePKM$20228$handle.invokeExact(imageData, offset, width, height, pixelSize).asInstanceOf[java.nio.ByteBuffer]
