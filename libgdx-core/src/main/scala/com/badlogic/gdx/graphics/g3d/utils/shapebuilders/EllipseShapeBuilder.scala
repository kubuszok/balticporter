...
object EllipseShapeBuilder {
  ...
  def build(builder: com.badlogic.gdx.graphics.g3d.utils.MeshPartBuilder, width: scala.Float, height: scala.Float, innerWidth: scala.Float, innerHeight: scala.Float, divisions: scala.Int, centerX: scala.Float, centerY: scala.Float, centerZ: scala.Float, normalX: scala.Float, normalY: scala.Float, normalZ: scala.Float, angleFrom: scala.Float, angleTo: scala.Float): scala.Unit = {
    ...
    EllipseShapeBuilder.build(builder, width, height, innerWidth, innerHeight, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV1.x, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV1.y, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV1.z, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV2.x, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV2.y, com.badlogic.gdx.graphics.g3d.utils.shapebuilders.BaseShapeBuilder.tmpV2.z, angleFrom, angleTo)
  }
