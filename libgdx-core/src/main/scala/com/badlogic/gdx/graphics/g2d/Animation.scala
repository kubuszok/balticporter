...
class Animation[T] {
  ...
  def this(frameDuration: scala.Float, keyFrames: com.badlogic.gdx.utils.Array[? <: T]) = {
    ...
    val frames: scala.Array[T] = java.util.Arrays.copyOf(keyFrames.items, keyFrames.size)
  ...
  def this(frameDuration: scala.Float, keyFrames: com.badlogic.gdx.utils.Array[? <: T], playMode: PlayMode) = {
    this(frameDuration, keyFrames)
    this.setPlayMode(playMode)
  }
  def getKeyFrame(stateTime: scala.Float, looping: scala.Boolean): T = {
    val oldPlayMode: PlayMode = this.playMode
  ...
  def getKeyFrameIndex(stateTime: scala.Float): scala.Int = {
    ...
    var frameNumber: scala.Int = (stateTime / this.frameDuration).asInstanceOf[scala.Int]
    this.playMode match {
      ...
      case PlayMode.LOOP_RANDOM => {
        var lastFrameNumber: scala.Int = (this.lastStateTime / this.frameDuration).asInstanceOf[scala.Int]
  ...
  protected def setKeyFrames(keyFrames: scala.Array[T]): scala.Unit = {
  ...
  def setPlayMode(playMode: PlayMode): scala.Unit = {
    this.playMode = playMode
  }
  def isAnimationFinished(stateTime: scala.Float): scala.Boolean = {
    val frameNumber: scala.Int = (stateTime / this.frameDuration).asInstanceOf[scala.Int]
