...
class Cubemap extends com.badlogic.gdx.graphics.GLTexture {
  ...
  def this(positiveX: com.badlogic.gdx.graphics.Pixmap, negativeX: com.badlogic.gdx.graphics.Pixmap, positiveY: com.badlogic.gdx.graphics.Pixmap, negativeY: com.badlogic.gdx.graphics.Pixmap, positiveZ: com.badlogic.gdx.graphics.Pixmap, negativeZ: com.badlogic.gdx.graphics.Pixmap, useMipMaps: scala.Boolean) = {
    this(if (positiveX == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(positiveX, null, useMipMaps, false), if (negativeX == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(negativeX, null, useMipMaps, false), if (positiveY == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(positiveY, null, useMipMaps, false), if (negativeY == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(negativeY, null, useMipMaps, false), if (positiveZ == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(positiveZ, null, useMipMaps, false), if (negativeZ == null) null else new com.badlogic.gdx.graphics.glutils.PixmapTextureData(negativeZ, null, useMipMaps, false))
  }
