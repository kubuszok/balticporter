...
class FrameBufferCubemap extends com.badlogic.gdx.graphics.glutils.GLFrameBuffer[com.badlogic.gdx.graphics.Cubemap] {
  ...
  protected def this(bufferBuilder: com.badlogic.gdx.graphics.glutils.GLFrameBuffer#GLFrameBufferBuilder[? <: com.badlogic.gdx.graphics.glutils.GLFrameBuffer[com.badlogic.gdx.graphics.Cubemap]]) = {
    this()
  }
  def this(format: com.badlogic.gdx.graphics.Pixmap#Format, width: scala.Int, height: scala.Int, hasDepth: scala.Boolean) = {
    this(format, width, height, hasDepth, false)
  }
  protected def createTexture(attachmentSpec: com.badlogic.gdx.graphics.glutils.GLFrameBuffer#FrameBufferTextureAttachmentSpec): com.badlogic.gdx.graphics.Cubemap = {
  ...
  protected def disposeColorTexture(colorTexture: com.badlogic.gdx.graphics.Cubemap): scala.Unit = {
    colorTexture.dispose()
  }
  protected def attachFrameBufferColorTexture(texture: com.badlogic.gdx.graphics.Cubemap): scala.Unit = {
  ...
  protected def bindSide(side: com.badlogic.gdx.graphics.Cubemap#CubemapSide): scala.Unit = {
