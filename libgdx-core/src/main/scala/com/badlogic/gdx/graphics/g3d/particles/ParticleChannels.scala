...
class ParticleChannels {
  ...
  protected def resetIds(): scala.Unit = {
  ...
  object TextureRegionInitializer {
    private var instance: TextureRegionInitializer = null.asInstanceOf[TextureRegionInitializer]
  ...
  object ColorInitializer {
    private var instance: ColorInitializer = null.asInstanceOf[ColorInitializer]
  ...
  object ScaleInitializer {
    private var instance: ScaleInitializer = null.asInstanceOf[ScaleInitializer]
  ...
  object Rotation2dInitializer {
    private var instance: Rotation2dInitializer = null.asInstanceOf[Rotation2dInitializer]
  ...
  object Rotation3dInitializer {
    private var instance: Rotation3dInitializer = null.asInstanceOf[Rotation3dInitializer]
