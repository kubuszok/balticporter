...
object ParticleChannels {
  ...
  final val Life: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 3)
  final val Position: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 3)
  final val PreviousPosition: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 3)
  final val Color: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 4)
  final val TextureRegion: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 6)
  final val Rotation2D: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 2)
  final val Rotation3D: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 4)
  final val Scale: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 1)
  final val ModelInstance: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[com.badlogic.gdx.graphics.g3d.ModelInstance](size)), 1)
  final val ParticleController: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[com.badlogic.gdx.graphics.g3d.particles.ParticleController](size)), 1)
  final val Acceleration: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 3)
  final val AngularVelocity2D: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 1)
  final val AngularVelocity3D: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(ParticleChannels.newGlobalId(), ((size: scala.Int) => new scala.Array[scala.Float](size)), 3)
  final val Interpolation: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(-1, ((size: scala.Int) => new scala.Array[scala.Float](size)), 2)
  final val Interpolation4: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(-1, ((size: scala.Int) => new scala.Array[scala.Float](size)), 4)
  final val Interpolation6: com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor = new com.badlogic.gdx.graphics.g3d.particles.ParallelArray.ChannelDescriptor(-1, ((size: scala.Int) => new scala.Array[scala.Float](size)), 6)
