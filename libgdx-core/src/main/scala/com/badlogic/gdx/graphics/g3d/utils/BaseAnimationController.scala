...
class BaseAnimationController {
  private final val transformPool: com.badlogic.gdx.utils.Pool[Transform] = new com.badlogic.gdx.utils.Pool[Transform]()
  ...
  protected def apply(animation: com.badlogic.gdx.graphics.g3d.model.Animation, time: scala.Float, weight: scala.Float): scala.Unit = {
    if (!this.applying) {
  ...
  protected def applyAnimation(animation: com.badlogic.gdx.graphics.g3d.model.Animation, time: scala.Float): scala.Unit = {
    if (this.applying) {
  ...
  protected def applyAnimations(anim1: com.badlogic.gdx.graphics.g3d.model.Animation, time1: scala.Float, anim2: com.badlogic.gdx.graphics.g3d.model.Animation, time2: scala.Float, weight: scala.Float): scala.Unit = {
  ...
  protected def removeAnimation(animation: com.badlogic.gdx.graphics.g3d.model.Animation): scala.Unit = {
  ...
  final class Transform extends com.badlogic.gdx.utils.Pool#Poolable {
    ...
    def set(t: com.badlogic.gdx.math.Vector3, r: com.badlogic.gdx.math.Quaternion, s: com.badlogic.gdx.math.Vector3): Transform = {
    ...
    def lerp(target: Transform, alpha: scala.Float): Transform = {
      return this.lerp(target.translation, target.rotation, target.scale, alpha)
    }
    def lerp(targetT: com.badlogic.gdx.math.Vector3, targetR: com.badlogic.gdx.math.Quaternion, targetS: com.badlogic.gdx.math.Vector3, alpha: scala.Float): Transform = {
...
object BaseAnimationController {
  private final val transforms: com.badlogic.gdx.utils.ObjectMap[com.badlogic.gdx.graphics.g3d.model.Node, Transform] = new com.badlogic.gdx.utils.ObjectMap[com.badlogic.gdx.graphics.g3d.model.Node, Transform]()
  private final val tmpT: Transform = new Transform()
  ...
  private final def getTranslationAtTime(nodeAnim: com.badlogic.gdx.graphics.g3d.model.NodeAnimation, time: scala.Float, out: com.badlogic.gdx.math.Vector3): com.badlogic.gdx.math.Vector3 = {
    ...
    out.set(firstKeyframe.value.asInstanceOf[com.badlogic.gdx.math.Vector3])
  ...
  private final def getRotationAtTime(nodeAnim: com.badlogic.gdx.graphics.g3d.model.NodeAnimation, time: scala.Float, out: com.badlogic.gdx.math.Quaternion): com.badlogic.gdx.math.Quaternion = {
    ...
    out.set(firstKeyframe.value.asInstanceOf[com.badlogic.gdx.math.Quaternion])
  ...
  private final def getNodeAnimationTransform(nodeAnim: com.badlogic.gdx.graphics.g3d.model.NodeAnimation, time: scala.Float): Transform = {
    val transform: Transform = BaseAnimationController.tmpT
  ...
  private final def applyNodeAnimationDirectly(nodeAnim: com.badlogic.gdx.graphics.g3d.model.NodeAnimation, time: scala.Float): scala.Unit = {
    ...
    val transform: Transform = BaseAnimationController.getNodeAnimationTransform(nodeAnim, time)
    transform.toMatrix4(node.localTransform)
  }
  private final def applyNodeAnimationBlending(nodeAnim: com.badlogic.gdx.graphics.g3d.model.NodeAnimation, out: com.badlogic.gdx.utils.ObjectMap[com.badlogic.gdx.graphics.g3d.model.Node, Transform], pool: com.badlogic.gdx.utils.Pool[Transform], alpha: scala.Float, time: scala.Float): scala.Unit = {
    val node: com.badlogic.gdx.graphics.g3d.model.Node = nodeAnim.node
    node.isAnimated = true
    val transform: Transform = BaseAnimationController.getNodeAnimationTransform(nodeAnim, time)
  ...
  protected def applyAnimation(out: com.badlogic.gdx.utils.ObjectMap[com.badlogic.gdx.graphics.g3d.model.Node, Transform], pool: com.badlogic.gdx.utils.Pool[Transform], alpha: scala.Float, animation: com.badlogic.gdx.graphics.g3d.model.Animation, time: scala.Float): scala.Unit = {
    if (out == null) {
      for (nodeAnim <- animation.nodeAnimations) {
