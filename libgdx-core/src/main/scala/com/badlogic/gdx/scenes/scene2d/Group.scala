...
class Group extends com.badlogic.gdx.scenes.scene2d.Actor with com.badlogic.gdx.scenes.scene2d.utils.Cullable {
  final val children: com.badlogic.gdx.utils.SnapshotArray[com.badlogic.gdx.scenes.scene2d.Actor] = new com.badlogic.gdx.utils.SnapshotArray[com.badlogic.gdx.scenes.scene2d.Actor](true, 4, ((size: scala.Int) => new scala.Array[com.badlogic.gdx.scenes.scene2d.Actor](size)))
