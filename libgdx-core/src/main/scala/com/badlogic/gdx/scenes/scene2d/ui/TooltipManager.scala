...
class TooltipManager {
  ...
  protected def showAction(tooltip: com.badlogic.gdx.scenes.scene2d.ui.Tooltip): scala.Unit = {
  ...
  protected def hideAction(tooltip: com.badlogic.gdx.scenes.scene2d.ui.Tooltip): scala.Unit = {
