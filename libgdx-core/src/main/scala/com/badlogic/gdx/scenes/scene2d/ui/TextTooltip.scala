...
class TextTooltip extends com.badlogic.gdx.scenes.scene2d.ui.Tooltip[com.badlogic.gdx.scenes.scene2d.ui.Label] with com.badlogic.gdx.scenes.scene2d.ui.Styleable[TextTooltipStyle] {
  private var style: TextTooltipStyle = null.asInstanceOf[TextTooltipStyle]
  def this(text: java.lang.String, manager: com.badlogic.gdx.scenes.scene2d.ui.TooltipManager, style: TextTooltipStyle) = {
    this()
  ...
  def this(text: java.lang.String, manager: com.badlogic.gdx.scenes.scene2d.ui.TooltipManager, skin: com.badlogic.gdx.scenes.scene2d.ui.Skin, styleName: java.lang.String) = {
    this(text, manager, skin.get(styleName, classOf[java.lang.Class]))
  }
  def this(text: java.lang.String, skin: com.badlogic.gdx.scenes.scene2d.ui.Skin, styleName: java.lang.String) = {
    this(text, com.badlogic.gdx.scenes.scene2d.ui.TooltipManager.getInstance(), skin.get(styleName, classOf[java.lang.Class]))
  }
  def this(text: java.lang.String, manager: com.badlogic.gdx.scenes.scene2d.ui.TooltipManager, skin: com.badlogic.gdx.scenes.scene2d.ui.Skin) = {
    this(text, manager, skin.get(classOf[java.lang.Class]))
  }
  def this(text: java.lang.String, skin: com.badlogic.gdx.scenes.scene2d.ui.Skin) = {
    this(text, com.badlogic.gdx.scenes.scene2d.ui.TooltipManager.getInstance(), skin.get(classOf[java.lang.Class]))
  }
  def this(text: java.lang.String, style: TextTooltipStyle) = {
  ...
  def setStyle(style: TextTooltipStyle): scala.Unit = {
    if (style == null) {
