...
class Skin extends com.badlogic.gdx.utils.Disposable {
  ...
  def load(skinFile: com.badlogic.gdx.files.FileHandle): scala.Unit = {
    try {
      this.getJsonLoader(skinFile).fromJson(classOf[java.lang.Class], skinFile)
    } catch {
  ...
  def addRegions(atlas: com.badlogic.gdx.graphics.g2d.TextureAtlas): scala.Unit = {
    ...
    { var i: scala.Int = 0; val n: scala.Int = regions.size; while (i < n) { {
      ...
      this.add(name, region, classOf[java.lang.Class])
    }; i = i + 1 } }
  }
  ...
  def add(name: java.lang.String, resource: java.lang.Object, `type`: java.lang.Class): scala.Unit = {
    ...
    if (typeResources == null) {
      typeResources = new com.badlogic.gdx.utils.ObjectMap(if (((`type` == classOf[java.lang.Class]) || (`type` == classOf[java.lang.Class])) || (`type` == classOf[java.lang.Class])) 256 else 64)
  ...
  def getColor(name: java.lang.String): com.badlogic.gdx.graphics.Color = {
    return this.get(name, classOf[java.lang.Class])
  }
  ...
  def getRegion(name: java.lang.String): com.badlogic.gdx.graphics.g2d.TextureRegion = {
    var region: com.badlogic.gdx.graphics.g2d.TextureRegion = this.optional(name, classOf[java.lang.Class])
    if (region != null) {
      return region
    } else ()
    val texture: com.badlogic.gdx.graphics.Texture = this.optional(name, classOf[java.lang.Class])
    if (texture == null) {
  ...
  def getRegions(regionName: java.lang.String): com.badlogic.gdx.utils.Array[com.badlogic.gdx.graphics.g2d.TextureRegion] = {
    ...
    var i: scala.Int = 0
    var region: com.badlogic.gdx.graphics.g2d.TextureRegion = this.optional((regionName + "_") + { i += 1; i }, classOf[java.lang.Class])
    if (region != null) {
      regions = new com.badlogic.gdx.utils.Array[com.badlogic.gdx.graphics.g2d.TextureRegion]()
      while (region != null) {
        regions.add(region)
        region = this.optional((regionName + "_") + { i += 1; i }, classOf[java.lang.Class])
      }
    } else ()
    return regions
  }
  def getTiledDrawable(name: java.lang.String): com.badlogic.gdx.scenes.scene2d.utils.TiledDrawable = {
    var tiled: com.badlogic.gdx.scenes.scene2d.utils.TiledDrawable = this.optional(name, classOf[java.lang.Class])
    if (tiled != null) {
      return tiled
    } else ()
    ...
    this.add(name, tiled, classOf[java.lang.Class])
    return tiled
  }
  def getPatch(name: java.lang.String): com.badlogic.gdx.graphics.g2d.NinePatch = {
    var patch: com.badlogic.gdx.graphics.g2d.NinePatch = this.optional(name, classOf[java.lang.Class])
    if (patch != null) {
      return patch
    } else ()
    try {
      ...
      this.add(name, patch, classOf[java.lang.Class])
      return patch
    } catch {
  ...
  def getSprite(name: java.lang.String): com.badlogic.gdx.graphics.g2d.Sprite = {
    var sprite: com.badlogic.gdx.graphics.g2d.Sprite = this.optional(name, classOf[java.lang.Class])
    if (sprite != null) {
      return sprite
    } else ()
    try {
      ...
      this.add(name, sprite, classOf[java.lang.Class])
      return sprite
    } catch {
      case ex: com.badlogic.gdx.utils.GdxRuntimeException => {
        throw new com.badlogic.gdx.utils.GdxRuntimeException("No NinePatch, TextureRegion, or Texture registered with name: " + name)
  ...
  def getDrawable(name: java.lang.String): com.badlogic.gdx.scenes.scene2d.utils.Drawable = {
    var drawable: com.badlogic.gdx.scenes.scene2d.utils.Drawable = this.optional(name, classOf[java.lang.Class])
    if (drawable != null) {
      return drawable
    } else ()
    try {
    ...
    if (drawable == null) {
      val patch: com.badlogic.gdx.graphics.g2d.NinePatch = this.optional(name, classOf[java.lang.Class])
      if (patch != null) {
        drawable = new com.badlogic.gdx.scenes.scene2d.utils.NinePatchDrawable(patch)
      } else {
        val sprite: com.badlogic.gdx.graphics.g2d.Sprite = this.optional(name, classOf[java.lang.Class])
        if (sprite != null) {
    ...
    this.add(name, drawable, classOf[java.lang.Class])
    return drawable
  }
  ...
  protected def getJsonLoader(skinFile: com.badlogic.gdx.files.FileHandle): com.badlogic.gdx.utils.Json = {
    val skin: Skin = this
    val json: com.badlogic.gdx.utils.Json = new com.badlogic.gdx.utils.Json()
    json.setTypeName(null)
    json.setUsePrototypes(false)
    json.setSerializer(classOf[java.lang.Class], new com.badlogic.gdx.utils.Json#ReadOnlySerializer[Skin]())
    json.setSerializer(classOf[java.lang.Class], new com.badlogic.gdx.utils.Json#ReadOnlySerializer[com.badlogic.gdx.graphics.g2d.BitmapFont]())
    json.setSerializer(classOf[java.lang.Class], new com.badlogic.gdx.utils.Json#ReadOnlySerializer[com.badlogic.gdx.graphics.Color]())
    json.setSerializer(classOf[java.lang.Class], new com.badlogic.gdx.utils.Json#ReadOnlySerializer())
...
object Skin {
  private final val defaultTagClasses: scala.Array[java.lang.Class] = Array[java.lang.Class](classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class], classOf[java.lang.Class])
