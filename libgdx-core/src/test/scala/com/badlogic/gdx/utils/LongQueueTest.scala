...
class LongQueueTest extends balticporter.runtime.PortedSuite {
  testCase("addFirstAndLastTest", {
    ...
    queue.addFirst(3)
    queue.addLast(4)
    org.junit.Assert.assertEquals(0, queue.indexOf(3))
    org.junit.Assert.assertEquals(1, queue.indexOf(1))
  ...
  testCase("removeLastTest", {
    ...
    org.junit.Assert.assertEquals(3, queue.indexOf(4))
    org.junit.Assert.assertEquals(4, queue.removeLast())
    org.junit.Assert.assertEquals(3, queue.size)
    org.junit.Assert.assertEquals(2, queue.indexOf(3))
    org.junit.Assert.assertEquals(3, queue.removeLast())
    org.junit.Assert.assertEquals(2, queue.size)
    org.junit.Assert.assertEquals(1, queue.indexOf(2))
    org.junit.Assert.assertEquals(2, queue.removeLast())
    org.junit.Assert.assertEquals(1, queue.size)
    org.junit.Assert.assertEquals(0, queue.indexOf(1))
  ...
  testCase("removeFirstTest", {
    ...
    org.junit.Assert.assertEquals(4, queue.size)
    org.junit.Assert.assertEquals(0, queue.indexOf(1))
    org.junit.Assert.assertEquals(1, queue.removeFirst())
    org.junit.Assert.assertEquals(3, queue.size)
    org.junit.Assert.assertEquals(0, queue.indexOf(2))
    org.junit.Assert.assertEquals(2, queue.removeFirst())
    org.junit.Assert.assertEquals(2, queue.size)
    org.junit.Assert.assertEquals(0, queue.indexOf(3))
    org.junit.Assert.assertEquals(3, queue.removeFirst())
    org.junit.Assert.assertEquals(1, queue.size)
    org.junit.Assert.assertEquals(0, queue.indexOf(4))
  ...
  testCase("resizableQueueTest", {
    ...
    { var i: scala.Int = 0; while (i < 100) { {
      { var j: scala.Int = 0; while (j < i) { {
        ...
        org.junit.Assert.assertTrue(((((("peekLast shows " + peeked) + ", should be ") + j) + " (") + i) + ")", peeked == j)
  ...
  testCase("resizableDequeTest", {
    ...
    { var i: scala.Int = 0; while (i < 100) { {
      { var j: scala.Int = 0; while (j < i) { {
        ...
        org.junit.Assert.assertTrue(((((("peek shows " + peeked) + ", should be ") + j) + " (") + i) + ")", peeked == j)
        val size: scala.Int = q.size
        org.junit.Assert.assertTrue(((((("Size should be " + (j + 1)) + " but is ") + size) + " (") + i) + ")", size == (j + 1))
      }; j = j + 1 } }
      if (i != 0) {
