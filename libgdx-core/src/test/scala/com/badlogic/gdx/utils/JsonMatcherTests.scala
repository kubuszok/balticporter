...
class JsonMatcherTests {
  ...
  def rejection(): scala.Unit = {
    {
      ...
      org.junit.Assert.assertEquals("9834711", value.getString("serial_num"))
      org.junit.Assert.assertNull(value.get("percentFull"))
    }
  ...
  def parseValue(): scala.Unit = {
    ...
    org.junit.Assert.assertEquals(100, root.getInt("percentFull"))
  ...
  def paths(): scala.Unit = {
    ...
    org.junit.Assert.assertEquals("[]/{}/devices/{}", paths.first().asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("[]/{}/devices/{}", paths.first().asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("[]/{}/devices/{}", paths.get(1).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("[]/{}/devices/{}", paths.get(2).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("[]/{}/devices/{}/child", paths.get(3).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("[]/{}/devices/{}/child", paths.get(4).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("{}/a/b/c/d/e/f", paths.get(5).asInstanceOf[java.lang.Object])
    JsonMatcherTests.assertValueCount(6, parents.asInstanceOf[com.badlogic.gdx.utils.Array[com.badlogic.gdx.utils.JsonValue]])
    org.junit.Assert.assertEquals("{}", parents.first().asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("{}", parents.get(1).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("{}", parents.get(2).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("child", parents.get(3).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("child", parents.get(4).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("f", parents.get(5).asInstanceOf[java.lang.Object])
    JsonMatcherTests.assertValueCount(6, parents2.asInstanceOf[com.badlogic.gdx.utils.Array[com.badlogic.gdx.utils.JsonValue]])
    org.junit.Assert.assertEquals("{}", parents2.first().asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("{}", parents2.get(1).asInstanceOf[java.lang.Object])
    org.junit.Assert.assertEquals("{}", parents2.get(2).asInstanceOf[java.lang.Object])
  ...
  def dataTypes(): scala.Unit = {
    ...
    org.junit.Assert.assertTrue(value.has("dc_switch_off"))
    org.junit.Assert.assertTrue(value.get("dc_switch_off").isNull())
      ...
      matcher.addPattern("*/(type@)", (value: com.badlogic.gdx.utils.JsonValue) => {
        if (value.equalsString("ENPOWER")) {
          ...
          if (value.equalsString("ENCHARGE")) {
            ...
            org.junit.Assert.fail("Unexpected type: " + value)
          }
        }
      })
      matcher.parse(JsonMatcherTests.json)
...
object JsonMatcherTests {
  ...
  def rejectAll(json: java.lang.String, rejectPattern: java.lang.String, pattern: java.lang.String, expected: scala.Array[java.lang.String]): scala.Unit = {
    ...
    try {
      ...
      { var i: scala.Int = 0; val n: scala.Int = expected.length; while (i < n) { {
        org.junit.Assert.assertEquals("Pattern " + i, expected(i), values.get(i).toJson(com.badlogic.gdx.utils.JsonWriter.OutputType.minimal))
      }; i = i + 1 } }
    } catch {
  ...
  def test(notParsedValue: java.lang.String, json: java.lang.String, patterns: scala.Array[java.lang.String], expected: scala.Array[java.lang.String]): scala.Unit = {
    ...
    try {
      ...
      { var i: scala.Int = 0; val n: scala.Int = expected.length; while (i < n) { {
        ...
        org.junit.Assert.assertEquals("Pattern " + i, expected(i), value.toJson(com.badlogic.gdx.utils.JsonWriter.OutputType.minimal))
      }; i = i + 1 } }
      if ((notParsedValue != null) && (!ended(0))) {
        org.junit.Assert.fail("Should have ended but did not")
      } else ()
    } catch {
      case ex: java.lang.AssertionError => {
  ...
  def assertValueCount(count: scala.Int, values: com.badlogic.gdx.utils.Array[com.badlogic.gdx.utils.JsonValue]): scala.Unit = {
    ...
    org.junit.Assert.assertEquals("Wrong match count", count, values.size)
  }
