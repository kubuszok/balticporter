...
class BezierTest extends balticporter.runtime.PortedSuite {
  ...
  testCase("testLinear2D", {
    ...
    balticporter.runtime.Asserts.assertEquals(1, d.x, BezierTest.epsilon)
    balticporter.runtime.Asserts.assertEquals(1, d.y, BezierTest.epsilon)
    val v: com.badlogic.gdx.math.Vector2 = this.bezier.valueAt(new com.badlogic.gdx.math.Vector2(), 0.5f)
    balticporter.runtime.Asserts.assertEquals(0.5f, v.x, BezierTest.epsilon)
    balticporter.runtime.Asserts.assertEquals(0.5f, v.y, BezierTest.epsilon)
    val t: scala.Float = this.bezier.approximate(new com.badlogic.gdx.math.Vector2(0.5f, 0.5f))
    balticporter.runtime.Asserts.assertEquals(0.5f, t, BezierTest.epsilonApprimations)
    val l: scala.Float = this.bezier.locate(new com.badlogic.gdx.math.Vector2(0.5f, 0.5f))
    balticporter.runtime.Asserts.assertEquals(0.5f, t, BezierTest.epsilon)
  })
}
object BezierTest {
