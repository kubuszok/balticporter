...
class IntersectorTest {
  def testSplitTriangle(): scala.Unit = {
    ...
    val split: com.badlogic.gdx.math.Intersector.SplitTriangle = new com.badlogic.gdx.math.Intersector.SplitTriangle(3);
    {
      ...
      org.junit.Assert.assertTrue(split.numBack == 1)
      org.junit.Assert.assertTrue(split.numFront == 0)
      org.junit.Assert.assertTrue(split.total == 1)
      org.junit.Assert.assertTrue(IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle))
      fTriangle(4) = 5.0f
      org.junit.Assert.assertFalse("Test is broken", IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle))
    };
    {
      val fTriangle: scala.Array[scala.Float] = scala.Array[scala.Float](10, 0, 10, 1, 0, 0, 12, 0, 10)
      com.badlogic.gdx.math.Intersector.splitTriangle(fTriangle, plane, split)
      org.junit.Assert.assertTrue(split.numBack == 0)
      org.junit.Assert.assertTrue(split.numFront == 1)
      org.junit.Assert.assertTrue(split.total == 1)
      org.junit.Assert.assertTrue(IntersectorTest.triangleEquals(split.front, 0, 3, fTriangle))
    };
    {
      ...
      org.junit.Assert.assertTrue(split.numBack == 2)
      org.junit.Assert.assertTrue(split.numFront == 1)
      org.junit.Assert.assertTrue(split.total == 3)
      org.junit.Assert.assertTrue(IntersectorTest.triangleEquals(split.front, 0, 3, scala.Array[scala.Float](0, 0, 5, 10, 0, 0, 0, 0, -5)))
    ...
    };
    {
      ...
      com.badlogic.gdx.math.Intersector.splitTriangle(triangle, plane, split)
      org.junit.Assert.assertTrue(split.numBack == 1)
      org.junit.Assert.assertTrue(split.numFront == 2)
      org.junit.Assert.assertTrue(split.total == 3)
      org.junit.Assert.assertTrue(IntersectorTest.triangleEquals(split.back, 0, 3, scala.Array[scala.Float](0, 0, 5, -10, 0, 0, 0, 0, -5)))
      val firstWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 0, 0, -5), scala.Array[scala.Float](10, 0, 10, 0, 0, -5, 10, 0, -10))
      val secondWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 10, 0, -10), scala.Array[scala.Float](0, 0, 5, 0, 0, -5, 10, 0, -10))
  ...
  def intersectSegmentCircle(): scala.Unit = {
    ...
    org.junit.Assert.assertTrue(intersects)
    ...
    org.junit.Assert.assertFalse(intersects)
    ...
    org.junit.Assert.assertTrue(intersects)
    org.junit.Assert.assertTrue(mtv.normal.equals(new com.badlogic.gdx.math.Vector2(-1.0f, 0)))
    org.junit.Assert.assertTrue(mtv.depth == 0.5f)
  ...
  def testIntersectPlanes(): scala.Unit = {
    ...
    org.junit.Assert.assertEquals(102.63903f, intersection.x, 0.1f)
  ...
  def testIsPointInTriangle3D(): scala.Unit = {
    ...
    org.junit.Assert.assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0.2f, 0, 1.25f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    org.junit.Assert.assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(2.6f, 0, 3.75f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    org.junit.Assert.assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    val epsilon: scala.Float = 1.0E-7f
    val almost1: scala.Float = 1 - epsilon
    org.junit.Assert.assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(almost1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
  ...
  def testIntersectPolygonsWithVertexLyingOnEdge(): scala.Unit = {
    ...
    org.junit.Assert.assertTrue(checkResult)
    org.junit.Assert.assertEquals(4, intersectionPolygon.getVertexCount())
    org.junit.Assert.assertEquals(new com.badlogic.gdx.math.Vector2(1.0f, -2.0f), intersectionPolygon.getVertex(0, new com.badlogic.gdx.math.Vector2()))
    org.junit.Assert.assertEquals(new com.badlogic.gdx.math.Vector2(1.0f, -1.5f), intersectionPolygon.getVertex(1, new com.badlogic.gdx.math.Vector2()))
  ...
  def testIntersectPolygonsWithTransformationsOnProvidedResultPolygon(): scala.Unit = {
    ...
    val checkResult: scala.Boolean = com.badlogic.gdx.math.Intersector.intersectPolygons(p1, p2, intersectionPolygon)
    org.junit.Assert.assertTrue(checkResult)
    org.junit.Assert.assertArrayEquals(scala.Array[scala.Float](1, -2, 1, -1.5f, 1.5f, -1.5f, 1.5f, -2), intersectionPolygon.getVertices(), 0)
    org.junit.Assert.assertArrayEquals(scala.Array[scala.Float](1, -2, 1, -1.5f, 1.5f, -1.5f, 1.5f, -2), intersectionPolygon.getTransformedVertices(), 0)
    intersectionPolygon.setScale(2, 2)
    org.junit.Assert.assertArrayEquals(scala.Array[scala.Float](2 * 1, 2 * (-2), 2 * 1, 2 * (-1.5f), 2 * 1.5f, 2 * (-1.5f), 2 * 1.5f, 2 * (-2)), intersectionPolygon.getTransformedVertices(), 0)
  }
}
object IntersectorTest {
  private def triangleEquals(base: scala.Array[scala.Float], baseOffset: scala.Int, stride: scala.Int, comp: scala.Array[scala.Float]): scala.Boolean = {
    org.junit.Assert.assertTrue(stride >= 3)
    org.junit.Assert.assertTrue((base.length - baseOffset) >= 9)
    org.junit.Assert.assertTrue(comp.length == 9)
    ...
    org.junit.Assert.assertTrue("Triangles do not have common first vertex.", offset != (-1));
    { var i: scala.Int = 0; while (i < 3) { {
