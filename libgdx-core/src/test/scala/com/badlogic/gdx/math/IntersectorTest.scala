...
class IntersectorTest extends munit.FunSuite {
  test("testSplitTriangle")({
    ...
    val split: com.badlogic.gdx.math.Intersector.SplitTriangle = new com.badlogic.gdx.math.Intersector.SplitTriangle(3);
    {
      ...
      assert(IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle))
      fTriangle(4) = 5.0f
      assertEquals(IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle), false, "Test is broken")
    };
    {
      val fTriangle: scala.Array[scala.Float] = scala.Array[scala.Float](10, 0, 10, 1, 0, 0, 12, 0, 10)
      com.badlogic.gdx.math.Intersector.splitTriangle(fTriangle, plane, split)
      ...
      assert(split.total == 1)
      assert(IntersectorTest.triangleEquals(split.front, 0, 3, fTriangle))
    };
    {
      ...
      assert(IntersectorTest.triangleEquals(split.front, 0, 3, scala.Array[scala.Float](0, 0, 5, 10, 0, 0, 0, 0, -5)))
      ...
      assert(first ^ second, ((("Either first or second way must be right (first: " + first) + ", second: ") + second) + ")")
    };
    {
      val triangle: scala.Array[scala.Float] = scala.Array[scala.Float](10, 0, 10, -10, 0, 0, 10, 0, -10)
      com.badlogic.gdx.math.Intersector.splitTriangle(triangle, plane, split)
      ...
      assert(split.total == 3)
      assert(IntersectorTest.triangleEquals(split.back, 0, 3, scala.Array[scala.Float](0, 0, 5, -10, 0, 0, 0, 0, -5)))
      val firstWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 0, 0, -5), scala.Array[scala.Float](10, 0, 10, 0, 0, -5, 10, 0, -10))
      val secondWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 10, 0, -10), scala.Array[scala.Float](0, 0, 5, 0, 0, -5, 10, 0, -10))
  ...
  test("intersectSegmentCircle")({
    ...
    assert(intersects)
    assert(mtv.normal.equals(new com.badlogic.gdx.math.Vector2(-1.0f, 0)))
    assert(mtv.depth == 0.5f)
    ...
    assert(intersects)
    assert(mtv.normal.equals(new com.badlogic.gdx.math.Vector2(0, 1.0f)) || mtv.normal.equals(new com.badlogic.gdx.math.Vector2(0.0f, -1.0f)))
    assert(mtv.depth == 4.0f)
  ...
  test("testIntersectPlanes")({
    ...
    assertEquals(0.1f, intersection.x, 102.63903f)
    assertEquals(0.1f, intersection.y, 57.7337f)
    assertEquals(0.1f, intersection.z, 100)
  ...
  test("testIsPointInTriangle2D")({
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector2(0.1f, 0), new com.badlogic.gdx.math.Vector2(0, 0), new com.badlogic.gdx.math.Vector2(1, 1), new com.badlogic.gdx.math.Vector2(-1, -1)), false)
    assert(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector2(0, 0.1f), new com.badlogic.gdx.math.Vector2(-1, 1), new com.badlogic.gdx.math.Vector2(1, 1), new com.badlogic.gdx.math.Vector2(-1, -2)))
  })
  test("testIsPointInTriangle3D")({
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0.1f, 0, 0), new com.badlogic.gdx.math.Vector3(0, 0, 0), new com.badlogic.gdx.math.Vector3(1, 1, 0), new com.badlogic.gdx.math.Vector3(-1, -1, 0)), false)
    assert(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, 0.1f, 0), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 0), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assert(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0.2f, 0, 1.25f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(2.6f, 0, 3.75f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)), false)
    assert(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    val epsilon: scala.Float = 1.0E-7f
    val almost1: scala.Float = 1 - epsilon
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(almost1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)), false)
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(199.0f, 1.0f, 500.0f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 5.0f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)), false)
    assertEquals(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(-5120.8345f, 8946.126f, -3270.5813f), new com.badlogic.gdx.math.Vector3(50.008057f, 22.20586f, 124.62208f), new com.badlogic.gdx.math.Vector3(62.282288f, 22.205864f, 109.665924f), new com.badlogic.gdx.math.Vector3(70.92052f, 7.205861f, 115.437805f)), false)
  })
  test("testIntersectPolygons")({
    val intersectionPolygon: com.badlogic.gdx.math.Polygon = new com.badlogic.gdx.math.Polygon()
    assertEquals(com.badlogic.gdx.math.Intersector.intersectPolygons(new com.badlogic.gdx.math.Polygon(scala.Array[scala.Float](3200.1453f, 88.00839f, 3233.9087f, 190.34174f, 3266.2905f, 0.0f)), new com.badlogic.gdx.math.Polygon(scala.Array[scala.Float](3213.0f, 131.0f, 3214.0f, 131.0f, 3214.0f, 130.0f, 3213.0f, 130.0f)), intersectionPolygon), false)
  ...
  test("testIntersectPolygonsWithVertexLyingOnEdge")({
    ...
    assertEquals(intersectionPolygon.getVertex(0, new com.badlogic.gdx.math.Vector2()), new com.badlogic.gdx.math.Vector2(1.0f, -2.0f))
    assertEquals(intersectionPolygon.getVertex(1, new com.badlogic.gdx.math.Vector2()), new com.badlogic.gdx.math.Vector2(1.0f, -1.5f))
    assertEquals(intersectionPolygon.getVertex(2, new com.badlogic.gdx.math.Vector2()), new com.badlogic.gdx.math.Vector2(1.5f, -1.5f))
    assertEquals(intersectionPolygon.getVertex(3, new com.badlogic.gdx.math.Vector2()), new com.badlogic.gdx.math.Vector2(1.5f, -2.0f))
  })
