...
class IntersectorTest extends balticporter.runtime.PortedSuite {
  testCase("testSplitTriangle", {
    ...
    val split: com.badlogic.gdx.math.Intersector.SplitTriangle = new com.badlogic.gdx.math.Intersector.SplitTriangle(3);
    {
      ...
      assertTrue(IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle))
      fTriangle(4) = 5.0f
      assertFalse("Test is broken", IntersectorTest.triangleEquals(split.back, 0, 3, fTriangle))
    };
    {
      val fTriangle: scala.Array[scala.Float] = scala.Array[scala.Float](10, 0, 10, 1, 0, 0, 12, 0, 10)
      com.badlogic.gdx.math.Intersector.splitTriangle(fTriangle, plane, split)
      ...
      assertTrue(split.total == 1)
      assertTrue(IntersectorTest.triangleEquals(split.front, 0, 3, fTriangle))
    };
    {
      ...
      assertTrue(IntersectorTest.triangleEquals(split.front, 0, 3, scala.Array[scala.Float](0, 0, 5, 10, 0, 0, 0, 0, -5)))
    ...
    };
    {
      ...
      assertTrue(split.total == 3)
      assertTrue(IntersectorTest.triangleEquals(split.back, 0, 3, scala.Array[scala.Float](0, 0, 5, -10, 0, 0, 0, 0, -5)))
      val firstWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 0, 0, -5), scala.Array[scala.Float](10, 0, 10, 0, 0, -5, 10, 0, -10))
      val secondWay: scala.Array[scala.Array[scala.Float]] = scala.Array[scala.Array[scala.Float]](scala.Array[scala.Float](10, 0, 10, 0, 0, 5, 10, 0, -10), scala.Array[scala.Float](0, 0, 5, 0, 0, -5, 10, 0, -10))
  ...
  testCase("intersectSegmentCircle", {
    ...
    assertTrue(intersects)
    assertTrue(mtv.normal.equals(new com.badlogic.gdx.math.Vector2(-1.0f, 0)))
    ...
    assertTrue(intersects)
    assertTrue(mtv.normal.equals(new com.badlogic.gdx.math.Vector2(0, 1.0f)) || mtv.normal.equals(new com.badlogic.gdx.math.Vector2(0.0f, -1.0f)))
    assertTrue(mtv.depth == 4.0f)
  ...
  testCase("testIsPointInTriangle2D", {
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector2(0.1f, 0), new com.badlogic.gdx.math.Vector2(0, 0), new com.badlogic.gdx.math.Vector2(1, 1), new com.badlogic.gdx.math.Vector2(-1, -1)))
    assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector2(0, 0.1f), new com.badlogic.gdx.math.Vector2(-1, 1), new com.badlogic.gdx.math.Vector2(1, 1), new com.badlogic.gdx.math.Vector2(-1, -2)))
  })
  testCase("testIsPointInTriangle3D", {
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0.1f, 0, 0), new com.badlogic.gdx.math.Vector3(0, 0, 0), new com.badlogic.gdx.math.Vector3(1, 1, 0), new com.badlogic.gdx.math.Vector3(-1, -1, 0)))
    assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, 0.1f, 0), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 0), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0.2f, 0, 1.25f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(2.6f, 0, 3.75f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1.4f, 0.99f, 2.5f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertTrue(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    val epsilon: scala.Float = 1.0E-7f
    val almost1: scala.Float = 1 - epsilon
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(0, -0.5f, 0.5f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(almost1, 1, 1), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(199.0f, 1.0f, 500.0f), new com.badlogic.gdx.math.Vector3(-1, 1, 0), new com.badlogic.gdx.math.Vector3(1, 1, 5.0f), new com.badlogic.gdx.math.Vector3(-1, -2, 0)))
    assertFalse(com.badlogic.gdx.math.Intersector.isPointInTriangle(new com.badlogic.gdx.math.Vector3(-5120.8345f, 8946.126f, -3270.5813f), new com.badlogic.gdx.math.Vector3(50.008057f, 22.20586f, 124.62208f), new com.badlogic.gdx.math.Vector3(62.282288f, 22.205864f, 109.665924f), new com.badlogic.gdx.math.Vector3(70.92052f, 7.205861f, 115.437805f)))
  })
  testCase("testIntersectPolygons", {
    val intersectionPolygon: com.badlogic.gdx.math.Polygon = new com.badlogic.gdx.math.Polygon()
    assertFalse(com.badlogic.gdx.math.Intersector.intersectPolygons(new com.badlogic.gdx.math.Polygon(scala.Array[scala.Float](3200.1453f, 88.00839f, 3233.9087f, 190.34174f, 3266.2905f, 0.0f)), new com.badlogic.gdx.math.Polygon(scala.Array[scala.Float](3213.0f, 131.0f, 3214.0f, 131.0f, 3214.0f, 130.0f, 3213.0f, 130.0f)), intersectionPolygon))
  ...
  testCase("testIntersectPolygonsWithVertexLyingOnEdge", {
    ...
    assertEquals(new com.badlogic.gdx.math.Vector2(1.0f, -2.0f), intersectionPolygon.getVertex(0, new com.badlogic.gdx.math.Vector2()))
    assertEquals(new com.badlogic.gdx.math.Vector2(1.0f, -1.5f), intersectionPolygon.getVertex(1, new com.badlogic.gdx.math.Vector2()))
    assertEquals(new com.badlogic.gdx.math.Vector2(1.5f, -1.5f), intersectionPolygon.getVertex(2, new com.badlogic.gdx.math.Vector2()))
    assertEquals(new com.badlogic.gdx.math.Vector2(1.5f, -2.0f), intersectionPolygon.getVertex(3, new com.badlogic.gdx.math.Vector2()))
  })
  testCase("testIntersectPolygonsWithTransformationsOnProvidedResultPolygon", {
    ...
    val checkResult: scala.Boolean = com.badlogic.gdx.math.Intersector.intersectPolygons(p1, p2, intersectionPolygon)
    assertTrue(checkResult)
    assertArrayEquals(scala.Array[scala.Float](1, -2, 1, -1.5f, 1.5f, -1.5f, 1.5f, -2), intersectionPolygon.getVertices(), 0)
    assertArrayEquals(scala.Array[scala.Float](1, -2, 1, -1.5f, 1.5f, -1.5f, 1.5f, -2), intersectionPolygon.getTransformedVertices(), 0)
    intersectionPolygon.setScale(2, 2)
    assertArrayEquals(scala.Array[scala.Float](2 * 1, 2 * (-2), 2 * 1, 2 * (-1.5f), 2 * 1.5f, 2 * (-1.5f), 2 * 1.5f, 2 * (-2)), intersectionPolygon.getTransformedVertices(), 0)
  })
}
