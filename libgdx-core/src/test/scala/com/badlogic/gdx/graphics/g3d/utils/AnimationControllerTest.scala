...
class AnimationControllerTest {
  def testGetFirstKeyframeIndexAtTimeNominal(): scala.Unit = {
    ...
    org.junit.Assert.assertEquals(0, com.badlogic.gdx.graphics.g3d.utils.BaseAnimationController.getFirstKeyframeIndexAtTime(keyFrames, -1.0f))
    org.junit.Assert.assertEquals(0, com.badlogic.gdx.graphics.g3d.utils.BaseAnimationController.getFirstKeyframeIndexAtTime(keyFrames, 0.0f))
    org.junit.Assert.assertEquals(0, com.badlogic.gdx.graphics.g3d.utils.BaseAnimationController.getFirstKeyframeIndexAtTime(keyFrames, 2.0f))
    org.junit.Assert.assertEquals(1, com.badlogic.gdx.graphics.g3d.utils.BaseAnimationController.getFirstKeyframeIndexAtTime(keyFrames, 9.0f))
...
object AnimationControllerTest {
  private def assertSameAnimation(expected: com.badlogic.gdx.graphics.g3d.model.Animation, actual: com.badlogic.gdx.graphics.g3d.utils.AnimationController.AnimationDesc): scala.Unit = {
    if (!expected.id.equals(actual.animation.id)) {
      org.junit.Assert.fail((("expected: " + expected.id) + ", actual: ") + actual.animation.id)
    } else ()
  }
}