...
re-runs it; the number is the distance to the demos. **2026-09-06, after the Pixels, graphics, properties and WorldUnits steps: pong + shared compile — 30 -> 21 -> 9 -> 4 -> 1 -> 0.** Next: the other eleven demos through the same check.
