...
thirty are attributed to a refusal or a limit this repository has already measured and written down**
— closing any of them means re-opening that entry with a number, not finding a bug:
