...
# drifted.
md_ext_modules := "flexmark-ext-aside flexmark-ext-resizable-image flexmark-ext-youtube-embedded flexmark-ext-anchorlink flexmark-ext-escaped-character flexmark-ext-ins flexmark-ext-superscript flexmark-ext-gfm-issues flexmark-ext-autolink flexmark-ext-gfm-users flexmark-ext-admonition flexmark-ext-yaml-front-matter flexmark-ext-jekyll-front-matter flexmark-ext-gfm-tasklist flexmark-ext-jekyll-tag flexmark-ext-abbreviation flexmark-ext-footnotes flexmark-ext-definition flexmark-ext-typographic flexmark-ext-emoji flexmark-ext-gitlab flexmark-ext-macros flexmark-ext-wikilink flexmark-ext-gfm-strikethrough flexmark-ext-media-tags"
