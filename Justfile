...
ts-export-terser:
    ...
    # ast.d.ts (generated by AstDtsGenerator) must be present in lib/ for
    # TS to type this.x accesses in DEFMETHOD bodies via the exported class
    # declarations; without it ~67% of typed nodes resolve as `any`.
