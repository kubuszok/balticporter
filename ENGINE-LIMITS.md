...
Numbers (floor -> final, ~2 dozen waves): anim8 0->1, textra 0->9, gltf 3->0(residue), vfx 0->0, ai 0->2, visui 7->6, gdx/gdx-test/screens 0->0 throughout; final corpus residue ~55 rows.
