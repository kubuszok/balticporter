...
/** Declaration-level constructor overrides for the flexmark-ext-xwiki-macros cold port — the irreducible constructor shapes the funnel refuses (genuinely different super targets). Only the
