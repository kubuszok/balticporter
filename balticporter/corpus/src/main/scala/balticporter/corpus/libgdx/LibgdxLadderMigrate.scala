    ...
    "extras" -> List(new balticporter.transform.AddMembersTransform(fromReference = Map(
      ...
      new balticporter.transform.AddMembersTransform(Map(
        ...
        "com.badlogic.gdx.scenes.scene2d.ui.Table" -> List(
          ...
          balticporter.transform.AddMembersTransform.MemberSpec("padTop_=", 0,
          ...
          balticporter.transform.AddMembersTransform.MemberSpec("padLeft_=", 0,
            ...
            Some("explicit property setter — resolves fluent overload ambiguity"), false),
          balticporter.transform.AddMembersTransform.MemberSpec("padRight_=", 0,
            ...
            Some("explicit property setter — resolves fluent overload ambiguity"), false),
          balticporter.transform.AddMembersTransform.MemberSpec("padBottom_=", 0,
