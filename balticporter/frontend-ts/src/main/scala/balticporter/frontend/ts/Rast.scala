...
/** Resolved AST (RAST) v1 — the JSON interchange format between the Node.js
  * TypeScript exporter and the Scala frontend. Every lowering decision lives
  * in Scala; the exporter is deliberately dumb. */
