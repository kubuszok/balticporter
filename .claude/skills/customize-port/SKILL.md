...
| `bean-properties` | `pairs`, `targets`, `scope`, `derive = true` | accessor pair → property over the override component; `derive` leaves a pair alone where the reference port keeps the java accessor name |
